...
var Maybe = class {
  ...
  isObserved() {
    var _a7;
    return (_a7 = (0, import_tslib.__classPrivateFieldGet)(this, _Maybe_value, "f")) === null || _a7 === void 0 ? void 0 : _a7[isObserved];
  }
  parsed() {
...
var Format = class {
  constructor(data) {
    ...
    this.color_info = data.colorInfo ? {
      primaries: (_a7 = data.colorInfo.primaries) === null || _a7 === void 0 ? void 0 : _a7.replace("COLOR_PRIMARIES_", ""),
...
var CommentsEntryPointHeader = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "contentRenderer")) {
      this.content_renderer = parser_default2.parseItem(data.contentRenderer, [CommentsEntryPointTeaser_default, CommentsSimplebox_default]);
    }
...
var CommentThread = class extends YTNode {
  ...
  getContinuation() {
    ...
    return (0, import_tslib4.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib4.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a7 = (0, import_tslib4.__classPrivateFieldGet)(this, _CommentThread_continuation, "f").button) === null || _a7 === void 0 ? void 0 : _a7.as(Button_default);
      if (!load_more_button)
...
var EngagementPanelTitleHeader = class extends YTNode {
  constructor(data) {
    super();
    this.title = new Text(data.title);
    this.visibility_button = parser_default2.parseItem(data.visibilityButton, Button_default);
  }
};
...
var MacroMarkersInfoItem = class extends YTNode {
  constructor(data) {
    ...
    this.menu = parser_default2.parseItem(data.menu, Menu_default);
  }
};
...
var MacroMarkersList = class extends YTNode {
  constructor(data) {
    super();
    this.contents = parser_default2.parseArray(data.contents, [MacroMarkersInfoItem_default, MacroMarkersListItem_default]);
...
var ExpandableVideoDescriptionBody = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "attributedDescriptionBodyText")) {
      this.attributed_description_body_text = (_a7 = data.attributedDescriptionBodyText) === null || _a7 === void 0 ? void 0 : _a7.content;
    }
  }
};
...
var ItemSection = class extends YTNode {
  constructor(data) {
    ...
    if (data.continuations) {
      this.continuation = (_c = (_b2 = (_a7 = data.continuations) === null || _a7 === void 0 ? void 0 : _a7.at(0)) === null || _b2 === void 0 ? void 0 : _b2.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation;
    }
  }
};
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  var _a7, _b2;
  const is_video = (_b2 = (_a7 = this.flex_columns.at(1)) === null || _a7 === void 0 ? void 0 : _a7.key("title").instanceof(Text).runs) === null || _b2 === void 0 ? void 0 : _b2.some((run) => run.text.match(/(.*?) views/));
  if (is_video) {
  ...
  this.id = (0, import_tslib5.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b2 = (_a7 = this.endpoint) === null || _a7 === void 0 ? void 0 : _a7.payload) === null || _b2 === void 0 ? void 0 : _b2.videoId);
  this.title = this.flex_columns.first().key("title").instanceof(Text).toString();
  ...
  const album_run = ((_j = (_h = this.flex_columns.at(1)) === null || _h === void 0 ? void 0 : _h.key("title").instanceof(Text).runs) === null || _j === void 0 ? void 0 : _j.find((run) => isTextRun(run) && run.endpoint && run.endpoint.payload.browseId.startsWith("MPR"))) || ((_l = (_k = this.flex_columns.at(2)) === null || _k === void 0 ? void 0 : _k.key("title").instanceof(Text).runs) === null || _l === void 0 ? void 0 : _l.find((run) => isTextRun(run) && run.endpoint && run.endpoint.payload.browseId.startsWith("MPR")));
  ...
  this.title = this.flex_columns.first().key("title").instanceof(Text).toString();
  this.views = (_c = (_b2 = (_a7 = this.flex_columns.at(1)) === null || _a7 === void 0 ? void 0 : _a7.key("title").instanceof(Text).runs) === null || _b2 === void 0 ? void 0 : _b2.find((run) => run.text.match(/(.*?) views/))) === null || _c === void 0 ? void 0 : _c.toString();
  const author_runs = (_e = (_d = this.flex_columns.at(1)) === null || _d === void 0 ? void 0 : _d.key("title").instanceof(Text).runs) === null || _e === void 0 ? void 0 : _e.filter((run) => isTextRun(run) && run.endpoint && run.endpoint.payload.browseId.startsWith("UC"));
  if (author_runs) {
  ...
  var _a7, _b2, _c, _d;
  this.name = this.flex_columns.first().key("title").instanceof(Text).toString();
  this.subtitle = (_a7 = this.flex_columns.at(1)) === null || _a7 === void 0 ? void 0 : _a7.key("title").instanceof(Text);
  ...
  const author_run = (_d = (_c = this.flex_columns.at(1)) === null || _c === void 0 ? void 0 : _c.key("title").instanceof(Text).runs) === null || _d === void 0 ? void 0 : _d.find((run) => isTextRun(run) && run.endpoint && run.endpoint.payload.browseId.startsWith("UC"));
  ...
  const author_run = (_f = (_e = this.flex_columns.at(1)) === null || _e === void 0 ? void 0 : _e.key("title").instanceof(Text).runs) === null || _f === void 0 ? void 0 : _f.find((run) => isTextRun(run) && run.endpoint && run.endpoint.payload.browseId.startsWith("UC"));
  if (author_run && isTextRun(author_run)) {
    this.author = {
      name: author_run.text,
...
var SearchFilterOptionsDialog = class extends YTNode {
  constructor(data) {
    super();
    this.title = new Text(data.title);
    this.groups = parser_default2.parseArray(data.groups, SearchFilterGroup_default);
  }
};
...
var SearchHeader = class extends YTNode {
  constructor(data) {
    super();
    this.chip_bar = parser_default2.parseItem(data.chipBar, ChipCloud_default);
    this.search_filter_button = parser_default2.parseItem(data.searchFilterButton, Button_default);
  }
};
...
var VideoSecondaryInfo = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "attributedDescription")) {
      this.description = new Text((0, import_tslib7.__classPrivateFieldGet)(this, _VideoSecondaryInfo_instances, "m", _VideoSecondaryInfo_convertAttributedDescriptionToRuns).call(this, data.attributedDescription));
    }
    this.subscribe_button = parser_default.parseItem(data.subscribeButton, [SubscribeButton_default, Button_default]);
...
var YTNodeGenerator = class {
  static isIgnoredKey(key) {
    return typeof key === "string" && (0, import_tslib8.__classPrivateFieldGet)(this, _a, "f", _YTNodeGenerator_ignored_keys).has(key);
  }
  ...
  static createRuntimeClass(classname, key_info) {
    var _b2, _key_info;
    (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_logNewClass).call(this, classname, key_info);
    const node = (_b2 = /* @__PURE__ */ __name(class extends YTNode {
      static set key_info(key_info2) {
        (0, import_tslib8.__classPrivateFieldSet)(this, _b2, new Map(key_info2), "f", _key_info);
      }
      static get key_info() {
        return [...(0, import_tslib8.__classPrivateFieldGet)(this, _b2, "f", _key_info).entries()];
      }
      constructor(data) {
        super();
        ...
        if (did_change) {
          ...
          (0, import_tslib8.__classPrivateFieldGet)(YTNodeGenerator, _a, "m", _YTNodeGenerator_logChangedKeys).call(YTNodeGenerator, classname, node.key_info, changed_keys);
        }
        ...
        for (const [key, value] of key_info2) {
          let snake_key = (0, import_tslib8.__classPrivateFieldGet)(YTNodeGenerator, _a, "m", _YTNodeGenerator_camelToSnake).call(YTNodeGenerator, key);
          if (value.type === "misc" && value.misc_type === "NavigationEndpoint")
            snake_key = "endpoint";
          Reflect.set(this, snake_key, YTNodeGenerator.parse(key, value, data));
        }
      }
    }, "_b"), (0, import_tslib8.__setFunctionName)(_b2, "node"), _b2.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _b2);
    node.key_info = key_info;
    Object.defineProperty(node, "name", { value: classname, writable: false });
    return node;
  }
  static introspect(classdata) {
    const key_info = (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_introspect).call(this, classdata);
    const dependencies = /* @__PURE__ */ new Map();
    for (const [, value] of key_info) {
      if (value.type === "renderer" || value.type === "renderer_list")
        for (const renderer of value.renderers) {
          const example = (0, import_tslib8.__classPrivateFieldGet)(this, _a, "f", _YTNodeGenerator_renderers_examples)[renderer];
          if (example)
  ...
  static generateTypescriptClass(classname, key_info) {
    ...
    for (const [key, value] of key_info) {
      let snake_key = (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_camelToSnake).call(this, key);
      if (value.type === "misc" && value.misc_type === "NavigationEndpoint")
        snake_key = "endpoint";
...
`;
  ...
  static toTypeDeclaration(inference_type, indentation = 0) {
    switch (inference_type.type) {
      ...
      case "object": {
        return `{
${inference_type.keys.map(([key, value]) => `${" ".repeat((indentation + 2) * 2)}${(0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_camelToSnake).call(this, key)}${value.optional ? "?" : ""}: ${this.toTypeDeclaration(value, indentation + 1)}`).join(",\n")}
      ...
      case "object":
        {
          ...
          parser = `{
${inference_type.keys.map(([key2, value]) => `${" ".repeat((indentation + 2) * 2)}${(0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_camelToSnake).call(this, key2)}: ${this.toParser(key2, value, new_keypath, indentation + 1)}`).join(",\n")}
${" ".repeat((indentation + 1) * 2)}}`;
        }
        break;
      case "misc":
  ...
  static parse(key, inference_type, data, key_path = ["data"]) {
    const should_optional = !inference_type.optional || (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data }, [...key_path, key]);
    switch (inference_type.type) {
      case "renderer": {
        return should_optional ? parser_default2.parseItem((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]), inference_type.renderers.map((type) => parser_default2.getParserByName(type))) : void 0;
      }
      case "renderer_list": {
        return should_optional ? parser_default2.parse((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]), true, inference_type.renderers.map((type) => parser_default2.getParserByName(type))) : void 0;
      }
      case "object": {
        const obj = {};
      ...
      case "misc":
        switch (inference_type.misc_type) {
          case "NavigationEndpoint":
            return should_optional ? new NavigationEndpoint_default((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Text":
            return should_optional ? new Text((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Thumbnail":
            return should_optional ? Thumbnail.fromResponse((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Author": {
            const author_should_optional = !inference_type.optional || (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[0]]);
            return author_should_optional ? new Author_default((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
          }
        }
        throw new Error("Unreachable code reached! Switch missing case!");
      case "primative":
      case "unknown":
        return (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]);
    }
  }
  static inferType(key, value) {
    let return_value = false;
    if (return_value = this.isRenderer(value)) {
      (0, import_tslib8.__classPrivateFieldGet)(this, _a, "f", _YTNodeGenerator_renderers_examples)[return_value] = value[Reflect.ownKeys(value)[0]];
      return {
        type: "renderer",
    ...
    if (return_value = this.isRendererList(value)) {
      for (const [key2, value2] of Object.entries(return_value)) {
        (0, import_tslib8.__classPrivateFieldGet)(this, _a, "f", _YTNodeGenerator_renderers_examples)[key2] = value2;
      }
      return {
        type: "renderer_list",
...
The following keys where altered: ${changed_keys.map(([key]) => (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_camelToSnake).call(this, key)).join(", ")}
...
${this.generateTypescriptClass(classname, key_info)}`);
  ...
  const key_info = (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_passOne).call(this, classdata);
  return (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_passTwo).call(this, key_info);
...
var Parser = class {
  static setParserErrorHandler(handler) {
    (0, import_tslib9.__classPrivateFieldSet)(this, _a2, handler, "f", _Parser_errorHandler);
  }
  static parseResponse(data) {
    var _b2, _c, _d;
    const parsed_data = {};
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_createMemo).call(this);
    const contents = this.parse(data.contents);
    const contents_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    if (contents) {
      parsed_data.contents = contents;
      parsed_data.contents_memo = contents_memo;
    }
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_clearMemo).call(this);
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_createMemo).call(this);
    const on_response_received_actions = data.onResponseReceivedActions ? this.parseRR(data.onResponseReceivedActions) : null;
    const on_response_received_actions_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_endpoints_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_commands_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    ...
    const continuation_contents_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    ...
    const actions_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    if (actions) {
    ...
    const live_chat_item_context_menu_supported_renderers_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    ...
    const header_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    if (header) {
    ...
    const sidebar_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    if (sidebar) {
    ...
    const engagement_panels = (_d = data.engagementPanels) === null || _d === void 0 ? void 0 : _d.map((e) => {
      const item = this.parseItem(e, EngagementPanelSectionList_default);
      return item;
    });
    ...
    if (items) {
      ...
      parsed_data.items_memo = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_getMemo).call(this);
    }
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_clearMemo).call(this);
    return parsed_data;
  }
  static parseItem(data, validTypes) {
    ...
    if (!this.shouldIgnore(classname)) {
      try {
        ...
        (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "m", _Parser_addToMemo).call(this, classname, result);
        return result;
      } catch (err) {
        (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_errorHandler).call(this, { classname, classdata: data[keys[0]], err });
        return null;
      }
    }
    return null;
...
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
      ...
      for (const menu_item of music_multi_select_menu_items) {
        const mutation = mutations.find((mutation2) => {
          var _b2, _c;
          return ((_c = (_b2 = mutation2.payload) === null || _b2 === void 0 ? void 0 : _b2.musicFormBooleanChoice) === null || _c === void 0 ? void 0 : _c.id) === menu_item.form_item_entity_key;
        });
...
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
  ...
  static getParserByName(classname) {
    const ParserConstructor = (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_rt_nodes).get(classname);
  ...
  static hasParser(classname) {
    return (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_rt_nodes).has(classname);
  }
  static addRuntimeParser(classname, ParserConstructor) {
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_rt_nodes).set(classname, ParserConstructor);
    (0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_dynamic_nodes).set(classname, ParserConstructor);
  }
  static getDynamicParsers() {
    return Object.fromEntries((0, import_tslib9.__classPrivateFieldGet)(this, _a2, "f", _Parser_dynamic_nodes));
  }
};
__name(Parser, "Parser");
_a2 = Parser, _Parser_clearMemo = /* @__PURE__ */ __name(function _Parser_clearMemo2() {
  (0, import_tslib9.__classPrivateFieldSet)(Parser, _a2, null, "f", _Parser_memo);
}, "_Parser_clearMemo"), _Parser_createMemo = /* @__PURE__ */ __name(function _Parser_createMemo2() {
  (0, import_tslib9.__classPrivateFieldSet)(Parser, _a2, new Memo(), "f", _Parser_memo);
}, "_Parser_createMemo"), _Parser_addToMemo = /* @__PURE__ */ __name(function _Parser_addToMemo2(classname, result) {
  if (!(0, import_tslib9.__classPrivateFieldGet)(Parser, _a2, "f", _Parser_memo))
    return;
  const list = (0, import_tslib9.__classPrivateFieldGet)(Parser, _a2, "f", _Parser_memo).get(classname);
  if (!list)
    return (0, import_tslib9.__classPrivateFieldGet)(Parser, _a2, "f", _Parser_memo).set(classname, [result]);
  list.push(result);
  ...
  return (0, import_tslib9.__classPrivateFieldGet)(Parser, _a2, "f", _Parser_memo);
...
_Parser_errorHandler = { value: (0, import_tslib9.__classPrivateFieldGet)(Parser, _a2, "m", _Parser_printError) };
...
var ItemSectionContinuation = class extends YTNode {
  constructor(data) {
    ...
    if (Array.isArray(data.continuations)) {
      this.continuation = (_d = (_c = (_b2 = data.continuations) === null || _b2 === void 0 ? void 0 : _b2.at(0)) === null || _c === void 0 ? void 0 : _c.nextContinuationData) === null || _d === void 0 ? void 0 : _d.continuation;
    }
  }
};
...
var AccountInfo = class {
  constructor(response) {
    ...
    (0, import_tslib10.__classPrivateFieldSet)(this, _AccountInfo_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib10.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const account_section_list = (0, import_tslib10.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents.array().as(AccountSectionList_default).first();
  ...
  get page() {
    return (0, import_tslib10.__classPrivateFieldGet)(this, _AccountInfo_page, "f");
  }
};
...
var Analytics = class {
  constructor(response) {
    ...
    (0, import_tslib11.__classPrivateFieldSet)(this, _Analytics_page, parser_default.parseResponse(response.data), "f");
    this.sections = (_a7 = (0, import_tslib11.__classPrivateFieldGet)(this, _Analytics_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
    return (0, import_tslib11.__classPrivateFieldGet)(this, _Analytics_page, "f");
  }
};
...
var Feed = class {
  constructor(actions, response, already_parsed = false) {
    ...
    if ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_isParsed).call(this, response) || already_parsed) {
      (0, import_tslib12.__classPrivateFieldSet)(this, _Feed_page, response, "f");
    } else {
      (0, import_tslib12.__classPrivateFieldSet)(this, _Feed_page, parser_default.parseResponse(response.data), "f");
    }
    const memo = concatMemos(...[
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").contents_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").continuation_contents_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_commands_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_endpoints_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_actions_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").sidebar_memo,
      (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo
    ]);
    if (!memo)
      throw new InnertubeError("No memo found in feed");
    (0, import_tslib12.__classPrivateFieldSet)(this, _Feed_memo, memo, "f");
    (0, import_tslib12.__classPrivateFieldSet)(this, _Feed_actions, actions, "f");
  }
  ...
  get videos() {
    return Feed.getVideosFromMemo((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get posts() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(BackstagePost_default, Post_default, SharedPost_default);
  }
  get channels() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Channel_default, GridChannel_default);
  }
  get playlists() {
    return Feed.getPlaylistsFromMemo((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get memo() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f");
  }
  get page_contents() {
    var _a7;
    const tab_content = (_a7 = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Tab_default)) === null || _a7 === void 0 ? void 0 : _a7.first().content;
    const reload_continuation_items = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ReloadContinuationItemsCommand).first();
    const append_continuation_items = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(AppendContinuationItemsAction_default).first();
    return tab_content || reload_continuation_items || append_continuation_items;
  }
  get shelves() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Shelf_default, RichShelf_default, ReelShelf_default);
  }
  getShelf(title) {
  ...
  get secondary_contents() {
    var _a7, _b2;
    if (!((_a7 = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.is_node))
      return void 0;
    const node = (_b2 = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _b2 === void 0 ? void 0 : _b2.item();
    if (!node.is(TwoColumnBrowseResults_default, TwoColumnSearchResults_default))
      return void 0;
    return node.secondary_contents;
  }
  get actions() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_actions, "f");
  }
  get page() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f");
  }
  get has_continuation() {
    return ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").get("ContinuationItem") || []).length > 0;
  }
  getContinuationData() {
    return (0, import_tslib12.__awaiter)(this, void 0, void 0, function* () {
      if ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_continuation, "f")) {
        if ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_continuation, "f").length > 1)
          throw new InnertubeError("There are too many continuations, you'll need to find the correct one yourself in this.page");
        if ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_continuation, "f").length === 0)
          throw new InnertubeError("There are no continuations");
        const response = yield (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_continuation, "f")[0].endpoint.call((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_actions, "f"), { parse: true });
        return response;
      }
      (0, import_tslib12.__classPrivateFieldSet)(this, _Feed_continuation, (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default), "f");
      if ((0, import_tslib12.__classPrivateFieldGet)(this, _Feed_continuation, "f"))
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib13.__classPrivateFieldSet)(this, _TabbedFeed_actions, actions, "f");
    (0, import_tslib13.__classPrivateFieldSet)(this, _TabbedFeed_tabs, (_a7 = this.page.contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Tab_default), "f");
  }
  get tabs() {
    var _a7, _b2;
    return (_b2 = (_a7 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.map((tab) => tab.title.toString())) !== null && _b2 !== void 0 ? _b2 : [];
  }
  getTabByName(title) {
    var _a7;
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a7 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
        throw new InnertubeError(`Tab "${title}" not found`);
      if (tab.selected)
        return this;
      const response = yield tab.endpoint.call((0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"));
      return new TabbedFeed((0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"), response, false);
    });
  }
  getTabByURL(url) {
    var _a7;
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a7 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.find((tab2) => {
        var _a8;
  ...
  hasTabWithURL(url) {
    var _a7, _b2;
    return (_b2 = (_a7 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.some((tab) => {
      var _a8;
...
var FilterableFeed = class extends Feed_default {
  ...
  get filter_chips() {
    var _a7, _b2;
    if ((0, import_tslib14.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f"))
      return (0, import_tslib14.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
    ...
    (0, import_tslib14.__classPrivateFieldSet)(this, _FilterableFeed_chips, this.memo.getType(ChipCloudChip_default), "f");
    return (0, import_tslib14.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
  }
  get filters() {
...
var Channel2 = class extends TabbedFeed_default {
  constructor(actions, data, already_parsed = false) {
    var _a7, _b2, _c, _d, _e, _f;
    super(actions, data, already_parsed);
    this.header = (_b2 = (_a7 = this.page.header) === null || _a7 === void 0 ? void 0 : _a7.item()) === null || _b2 === void 0 ? void 0 : _b2.as(C4TabbedHeader_default, CarouselHeader_default, InteractiveTabbedHeader_default, PageHeader_default);
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib16.__classPrivateFieldSet)(this, _Comments_page, already_parsed ? data : parser_default.parseResponse(data), "f");
    (0, import_tslib16.__classPrivateFieldSet)(this, _Comments_actions, actions, "f");
    const contents = (0, import_tslib16.__classPrivateFieldGet)(this, _Comments_page, "f").on_response_received_endpoints;
    if (!contents)
    ...
    this.contents = observe(threads.map((thread) => {
      var _a8;
      (_a8 = thread.comment) === null || _a8 === void 0 ? void 0 : _a8.setActions((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      thread.setActions((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      return thread;
    }));
    (0, import_tslib16.__classPrivateFieldSet)(this, _Comments_continuation, (_c = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _c === void 0 ? void 0 : _c.firstOfType(ContinuationItem_default), "f");
  }
  applySort(sort) {
    var _a7, _b2, _c, _d;
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (button.selected)
        return this;
      const response = yield button.endpoint.call((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      return new Comments((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"), response, true);
    });
  }
  createComment(text) {
    var _a7;
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield button.endpoint.call((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"), { commentText: text });
      return response;
    });
  }
  getContinuation() {
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib16.__classPrivateFieldGet)(this, _Comments_continuation, "f"))
        throw new InnertubeError("Continuation not found");
      const data = yield (0, import_tslib16.__classPrivateFieldGet)(this, _Comments_continuation, "f").endpoint.call((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      const page = Object.assign({}, (0, import_tslib16.__classPrivateFieldGet)(this, _Comments_page, "f"));
      ...
      return new Comments((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"), page, true);
    });
  }
  get has_continuation() {
    return !!(0, import_tslib16.__classPrivateFieldGet)(this, _Comments_continuation, "f");
  }
  get page() {
    return (0, import_tslib16.__classPrivateFieldGet)(this, _Comments_page, "f");
  }
};
...
var Guide = class {
  constructor(data) {
    ...
    (0, import_tslib17.__classPrivateFieldSet)(this, _Guide_page, parser_default2.parseResponse(data), "f");
    this.contents = (0, import_tslib17.__classPrivateFieldGet)(this, _Guide_page, "f").items.array().as(GuideSection_default, GuideSubscriptionsSection_default);
  }
  get page() {
    return (0, import_tslib17.__classPrivateFieldGet)(this, _Guide_page, "f");
  }
};
__name(Guide, "Guide");
...
var ItemMenu = class {
  constructor(data, actions) {
    ...
    (0, import_tslib21.__classPrivateFieldSet)(this, _ItemMenu_page, data, "f");
    (0, import_tslib21.__classPrivateFieldSet)(this, _ItemMenu_actions, actions, "f");
    ...
    (0, import_tslib21.__classPrivateFieldSet)(this, _ItemMenu_items, menu.as(Menu_default).items, "f");
  }
  selectItem(item) {
    return (0, import_tslib21.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (item instanceof Button_default) {
        ...
        const button = (0, import_tslib21.__classPrivateFieldGet)(this, _ItemMenu_items, "f").find((button2) => {
      ...
      const response = yield endpoint.call((0, import_tslib21.__classPrivateFieldGet)(this, _ItemMenu_actions, "f"), { parse: true });
      return response;
    });
  }
  items() {
    return (0, import_tslib21.__classPrivateFieldGet)(this, _ItemMenu_items, "f");
  }
  page() {
    return (0, import_tslib21.__classPrivateFieldGet)(this, _ItemMenu_page, "f");
  }
};
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    this.info = Object.assign(Object.assign({}, (_a7 = this.page.metadata) === null || _a7 === void 0 ? void 0 : _a7.item().as(PlaylistMetadata_default)), {
      ...
      total_items: (0, import_tslib22.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 0, primary_info),
      views: (0, import_tslib22.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 1, primary_info),
      last_updated: (0, import_tslib22.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 2, primary_info),
  ...
  constructor(actions, data) {
    ...
    this.sections = shelves.map((shelf) => {
      ...
      return {
        ...
        getAll: () => (0, import_tslib23.__classPrivateFieldGet)(this, _Library_instances, "m", _Library_getAll).call(this, shelf)
      };
    });
  }
  get history() {
...
var EventEmitterLike = class extends EventTarget {
  ...
  on(type, listener) {
    ...
    (0, import_tslib24.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").set(listener, wrapper);
  ...
  off(type, listener) {
    const wrapper = (0, import_tslib24.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").get(listener);
    if (wrapper) {
      this.removeEventListener(type, wrapper);
      (0, import_tslib24.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").delete(listener);
    }
  }
};
  ...
  emitSmoothedActions() {
    ...
    if ((0, import_tslib25.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length) {
      ...
      if ((0, import_tslib25.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f") !== null) {
        delay == 1 ? (delay = (0, import_tslib25.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") / (0, import_tslib25.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length, delay *= Math.random() + 0.5, delay = Math.min(1e3, delay), delay = Math.max(80, delay)) : delay = 80;
...
var LiveChat2 = class extends EventEmitterLike_default {
  constructor(video_info) {
    ...
    (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_continuation, (_a7 = video_info.livechat) === null || _a7 === void 0 ? void 0 : _a7.continuation, "f");
    ...
    this.smoothed_queue.callback = (actions) => (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
      if (!actions.length) {
        yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else if (actions.length < 10) {
        yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
  ...
  sendMessage(text) {
    return (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/live_chat/send_message", {
        params: proto_default.encodeMessageParams((0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_channel_id, "f"), (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_video_id, "f")),
  ...
  applyFilter(filter) {
    ...
    if (filter === "TOP_CHAT") {
      if ((_d = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _d === void 0 ? void 0 : _d.selected)
        return;
      (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_continuation, (_e = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
    } else {
      if ((_f = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _f === void 0 ? void 0 : _f.selected)
        return;
      (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_continuation, (_g = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _g === void 0 ? void 0 : _g.continuation, "f");
    }
  }
  getItemMenu(item) {
    return (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.key("menu_endpoint").instanceof(NavigationEndpoint_default).call((0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      if (!response)
  ...
  selectButton(button) {
    return (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
      const response = yield button.endpoint.call((0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      return response;
    });
  }
};
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
    var _a7, _b2;
    try {
      const response = yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute(this.is_replay ? "live_chat/get_live_chat_replay" : "live_chat/get_live_chat", { continuation: (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_continuation, "f"), parse: true });
      ...
      this.emit("error", err);
      if (((0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_retry_count, (_b2 = (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_retry_count, "f"), _a7 = _b2++, _b2), "f"), _a7) < 10) {
        yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  return (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
    ...
    for (const action of action_queue) {
      yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, emit_delay_ms);
  ...
  (() => (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      ...
      const response = yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/updated_metadata", payload);
      const data = parser_default.parseResponse(response.data);
      (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_mcontinuation, (_a7 = data.continuation) === null || _a7 === void 0 ? void 0 : _a7.token, "f");
      this.metadata = {
      ...
      yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 5e3);
      if (this.running)
...
var NotificationsMenu = class {
  constructor(actions, response) {
    ...
    (0, import_tslib27.__classPrivateFieldSet)(this, _NotificationsMenu_page, parser_default.parseResponse(response.data), "f");
  ...
  getContinuation() {
    return (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
      const continuation = (0, import_tslib27.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(ContinuationItem_default).first();
      if (!continuation)
        throw new InnertubeError("Continuation not found");
      const response = yield continuation.endpoint.call((0, import_tslib27.__classPrivateFieldGet)(this, _NotificationsMenu_actions, "f"), { parse: false });
...
var Settings = class {
  constructor(actions, response) {
    ...
    (0, import_tslib29.__classPrivateFieldSet)(this, _Settings_actions, actions, "f");
    (0, import_tslib29.__classPrivateFieldSet)(this, _Settings_page, parser_default.parseResponse(response.data), "f");
    this.sidebar = (_a7 = (0, import_tslib29.__classPrivateFieldGet)(this, _Settings_page, "f").sidebar) === null || _a7 === void 0 ? void 0 : _a7.as(SettingsSidebar_default);
    if (!(0, import_tslib29.__classPrivateFieldGet)(this, _Settings_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib29.__classPrivateFieldGet)(this, _Settings_page, "f").contents.item().as(TwoColumnBrowseResults_default).tabs.array().as(Tab_default).get({ selected: true });
    if (!tab)
  ...
  selectSidebarItem(target_item) {
    return (0, import_tslib29.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.endpoint.call((0, import_tslib29.__classPrivateFieldGet)(this, _Settings_actions, "f"), { parse: false });
      return new Settings((0, import_tslib29.__classPrivateFieldGet)(this, _Settings_actions, "f"), response);
    });
  }
  ...
  get page() {
    return (0, import_tslib29.__classPrivateFieldGet)(this, _Settings_page, "f");
  }
};
...
var TimeWatched = class {
  constructor(response) {
    ...
    (0, import_tslib30.__classPrivateFieldSet)(this, _TimeWatched_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib30.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib30.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
  ...
  get page() {
    return (0, import_tslib30.__classPrivateFieldGet)(this, _TimeWatched_page, "f");
  }
};
...
var _FormatUtils_hoistCodecsIfPossible;
var _FormatUtils_hoistNumberAttributeIfPossible;
var _FormatUtils_hoistAudioChannelsIfPossible;
var _FormatUtils_generateRepresentationVideo;
var _FormatUtils_generateRepresentationAudio;
var _FormatUtils_generateRepresentationImage;
...
var FormatUtils = class {
  static download(options, actions, playability_status, streaming_data, player, cpn) {
    return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
      ...
      const readable_stream = new Platform.shim.ReadableStream({
        ...
        pull: (controller) => (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
          if (must_end) {
            controller.close();
            return;
          }
          ...
          return new Promise((resolve, reject) => (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
            var _b2, e_1, _c, _d;
            try {
              ...
              try {
                for (var _e = true, _f = (0, import_tslib31.__asyncValues)(streamToIterable(body)), _g; _g = yield _f.next(), _b2 = _g.done, !_b2; _e = true) {
                  _d = _g.value;
                  _e = false;
                  const chunk = _d;
  ...
  static toDash(streaming_data, url_transformer = (url) => url, format_filter, cpn, player, actions, storyboards) {
    return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
      ...
      mpd.replaceWith((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "MPD", {
      ...
      yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateAdaptationSet).call(this, document, period, adaptive_formats, url_transformer, cpn, player, actions, storyboards);
...
_a3 = FormatUtils, _FormatUtils_el = /* @__PURE__ */ __name(function _FormatUtils_el2(document, tag, attrs, children = []) {
  ...
  return el;
}, "_FormatUtils_el"), _FormatUtils_generateAdaptationSet = /* @__PURE__ */ __name(function _FormatUtils_generateAdaptationSet2(document, period, formats, url_transformer, cpn, player, actions, storyboards) {
  var _b2, _c, _d;
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    const mime_types = [];
    const mime_objects = [[]];
    ...
    for (let i = 0; i < mime_types.length; i++) {
      if (mime_objects[i][0].has_audio && mime_objects[i][0].audio_track) {
        ...
        for (let j = 0; j < track_ids.length; j++) {
          ...
          children.push((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Role", {
            schemeIdUri: "urn:mpeg:dash:role:2011",
            value: role
          }), (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Label", {
            id: set_id.toString()
          }, [
            document.createTextNode((_c = first_format.audio_track) === null || _c === void 0 ? void 0 : _c.display_name)
          ]));
          const set = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
            id: `${set_id++}`,
          ...
          const hoisted = [];
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistCodecsIfPossible).call(this, set, track_objects[j], hoisted);
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistNumberAttributeIfPossible).call(this, set, track_objects[j], "audioSamplingRate", "audio_sample_rate", hoisted);
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistAudioChannelsIfPossible).call(this, document, set, track_objects[j], hoisted);
          period.appendChild(set);
          for (const format of track_objects[j]) {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, hoisted, cpn, player, actions);
          }
        }
      } else {
        const set = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
        ...
        if (typeof color_info !== "undefined") {
          if (color_info.primaries) {
            ...
            if (primaries !== "") {
              set.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "EssentialProperty", {
...
format:`, anonymisedFormat);
        ...
        const hoisted = [];
        (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistCodecsIfPossible).call(this, set, mime_objects[i], hoisted);
        if (mime_objects[i][0].has_audio) {
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistNumberAttributeIfPossible).call(this, set, mime_objects[i], "audioSamplingRate", "audio_sample_rate", hoisted);
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistAudioChannelsIfPossible).call(this, document, set, mime_objects[i], hoisted);
          ...
          (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_hoistNumberAttributeIfPossible).call(this, set, mime_objects[i], "frameRate", "fps", hoisted);
        }
        period.appendChild(set);
        for (const format of mime_objects[i]) {
          if (format.has_video) {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationVideo).call(this, document, set, format, url_transformer, hoisted, cpn, player, actions);
          } else {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, hoisted, cpn, player, actions);
          }
        }
    ...
    if (storyboards && actions) {
      ...
      for (const storyboard of storyboards.boards) {
        ...
        const mime_type_index = mime_types2.indexOf(mime_type);
        if (mime_type_index > -1) {
          mime_objects2[mime_type_index].push(storyboard);
        } else {
          mime_types2.push(mime_type);
          mime_objects2.push([]);
          mime_objects2[mime_types2.length - 1].push(storyboard);
        }
      }
      const duration = formats[0].approx_duration_ms / 1e3;
      for (let i = 0; i < mime_types2.length; i++) {
        const set = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
          id: `${set_id++}`,
          mimeType: mime_types2[i],
          contentType: "image"
        });
        period.appendChild(set);
        for (const storyboard of mime_objects2[i]) {
          yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationImage).call(this, document, set, storyboard, duration, url_transformer, actions);
        }
      }
    }
  });
}, "_FormatUtils_generateAdaptationSet"), _FormatUtils_hoistCodecsIfPossible = /* @__PURE__ */ __name(function _FormatUtils_hoistCodecsIfPossible2(set, formats, hoisted) {
...
}, "_FormatUtils_hoistCodecsIfPossible"), _FormatUtils_hoistNumberAttributeIfPossible = /* @__PURE__ */ __name(function _FormatUtils_hoistNumberAttributeIfPossible2(set, formats, attribute, property, hoisted) {
  var _b2;
  if (formats.length > 1 && new Set(formats.map((format) => format.fps)).size === 1) {
    set.setAttribute(attribute, (_b2 = formats[0][property]) === null || _b2 === void 0 ? void 0 : _b2.toString());
    hoisted.push(attribute);
  }
}, "_FormatUtils_hoistNumberAttributeIfPossible"), _FormatUtils_hoistAudioChannelsIfPossible = /* @__PURE__ */ __name(function _FormatUtils_hoistAudioChannelsIfPossible2(document, set, formats, hoisted) {
  var _b2;
  if (formats.length > 1 && new Set(formats.map((format) => {
    var _b3;
    return ((_b3 = format.audio_channels) === null || _b3 === void 0 ? void 0 : _b3.toString()) || "2";
  })).size === 1) {
    set.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AudioChannelConfiguration", {
      schemeIdUri: "urn:mpeg:dash:23003:3:audio_channel_configuration:2011",
      value: ((_b2 = formats[0].audio_channels) === null || _b2 === void 0 ? void 0 : _b2.toString()) || "2"
    }));
    hoisted.push("AudioChannelConfiguration");
  }
}, "_FormatUtils_hoistAudioChannelsIfPossible"), _FormatUtils_generateRepresentationVideo = /* @__PURE__ */ __name(function _FormatUtils_generateRepresentationVideo2(document, set, format, url_transformer, hoisted, cpn, player, actions) {
  var _b2, _c, _d, _e, _f, _g;
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    const url = new URL(format.decipher(player));
    url.searchParams.set("cpn", cpn || "");
    const representation = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Representation", {
    ...
    yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateSegmentInformation).call(this, document, representation, format, (_g = url_transformer(url)) === null || _g === void 0 ? void 0 : _g.toString(), actions);
  });
}, "_FormatUtils_generateRepresentationVideo"), _FormatUtils_generateRepresentationAudio = /* @__PURE__ */ __name(function _FormatUtils_generateRepresentationAudio2(document, set, format, url_transformer, hoisted, cpn, player, actions) {
  var _b2, _c, _d, _e, _f, _g;
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    const url = new URL(format.decipher(player));
    url.searchParams.set("cpn", cpn || "");
    ...
    if (!hoisted.includes("AudioChannelConfiguration")) {
      representation.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AudioChannelConfiguration", {
        schemeIdUri: "urn:mpeg:dash:23003:3:audio_channel_configuration:2011",
...
}, "_FormatUtils_generateRepresentationAudio"), _FormatUtils_generateRepresentationImage = /* @__PURE__ */ __name(function _FormatUtils_generateRepresentationImage2(document, set, storyboard, duration, url_transformer, actions) {
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    ...
    const representation = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Representation", {
      ...
      (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "EssentialProperty", {
        schemeIdUri: "http://dashif.org/thumbnail_tile",
        value: `${storyboard.columns}x${storyboard.rows}`
      }),
      (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "SegmentTemplate", {
...
}, "_FormatUtils_generateRepresentationImage"), _FormatUtils_generateSegmentInformation = /* @__PURE__ */ __name(function _FormatUtils_generateSegmentInformation2(document, representation, format, url, actions) {
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    if (format.is_type_otf) {
      ...
      const { resolved_url, segment_durations } = yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_getOTFSegmentInformation).call(this, url, actions);
      ...
      for (const segment_duration of segment_durations) {
        ...
        segment_elements.push((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "S", attributes));
      }
      representation.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "SegmentTemplate", {
        startNumber: "1",
        timescale: "1000",
        initialization: `${resolved_url}&sq=0`,
        media: `${resolved_url}&sq=$Number$`
      }, [
        (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "SegmentTimeline", {}, segment_elements)
      ]));
    } else {
      if (!format.index_range || !format.init_range)
        throw new InnertubeError("Index and init ranges not available", { format });
      representation.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "BaseURL", {}, [
        document.createTextNode(url)
      ]));
      representation.appendChild((0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "SegmentBase", {
        indexRange: `${format.index_range.start}-${format.index_range.end}`
      }, [
        (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Initialization", {
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    (0, import_tslib32.__classPrivateFieldSet)(this, _MediaInfo_actions, actions, "f");
    ...
    (0, import_tslib32.__classPrivateFieldSet)(this, _MediaInfo_page, [info, next], "f");
    (0, import_tslib32.__classPrivateFieldSet)(this, _MediaInfo_cpn, cpn, "f");
    if (((_b2 = info.playability_status) === null || _b2 === void 0 ? void 0 : _b2.status) === "ERROR")
      throw new InnertubeError("This video is unavailable", info.playability_status);
    this.streaming_data = info.streaming_data;
    this.playability_status = info.playability_status;
    (0, import_tslib32.__classPrivateFieldSet)(this, _MediaInfo_playback_tracking, info.playback_tracking, "f");
  }
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return (0, import_tslib32.__awaiter)(this, void 0, void 0, function* () {
      let storyboards;
      if (options.include_thumbnails && ((_a7 = (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards) === null || _a7 === void 0 ? void 0 : _a7.is(PlayerStoryboardSpec_default))) {
        storyboards = (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards;
      }
      return FormatUtils_default.toDash(this.streaming_data, url_transformer, format_filter, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"), (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), storyboards);
    });
  }
  ...
  download(options = {}) {
    return (0, import_tslib32.__awaiter)(this, void 0, void 0, function* () {
      return FormatUtils_default.download(options, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  addToWatchHistory(client_name = CLIENTS.WEB.NAME, client_version = CLIENTS.WEB.VERSION, replacement = "https://www.") {
    return (0, import_tslib32.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f"))
        throw new InnertubeError("Playback tracking not available");
      const url_params = {
        cpn: (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"),
        fmt: 251,
        rtn: 0,
        rt: 0
      };
      const url = (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f").videostats_playback_url.replace("https://s.", replacement);
      const response = yield (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").stats(url, {
        client_name,
        client_version
      }, url_params);
      return response;
  ...
  get actions() {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f");
  }
  get cpn() {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f");
  }
  get page() {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_page, "f");
  }
};
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    var _a7, _b2, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17;
    ...
    if (this.streaming_data) {
      const default_audio_track = this.streaming_data.adaptive_formats.find((format) => {
        var _a8;
        return (_a8 = format.audio_track) === null || _a8 === void 0 ? void 0 : _a8.audio_is_default;
      });
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_5 = this.watch_next_feed.at(-1)) === null || _5 === void 0 ? void 0 : _5.is(ContinuationItem_default)))
        (0, import_tslib33.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_6 = this.watch_next_feed.pop()) === null || _6 === void 0 ? void 0 : _6.as(ContinuationItem_default), "f");
  ...
  getWatchNextContinuation() {
    var _a7, _b2, _c, _d, _e;
    return (0, import_tslib33.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib33.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f"))
        throw new InnertubeError("Watch next feed continuation not found");
      const response = yield (_a7 = (0, import_tslib33.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f")) === null || _a7 === void 0 ? void 0 : _a7.endpoint.call(this.actions, { parse: true });
      ...
      if ((_d = (_c = this.watch_next_feed) === null || _c === void 0 ? void 0 : _c.at(-1)) === null || _d === void 0 ? void 0 : _d.is(ContinuationItem_default)) {
        (0, import_tslib33.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_e = this.watch_next_feed.pop()) === null || _e === void 0 ? void 0 : _e.as(ContinuationItem_default), "f");
      } else {
        (0, import_tslib33.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, void 0, "f");
      }
      return this;
    });
  }
  ...
  get wn_has_continuation() {
    return !!(0, import_tslib33.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f");
  }
  ...
  get music_tracks() {
    var _a7, _b2, _c, _d, _e, _f;
    const description_content = (_b2 = (_a7 = this.page[1]) === null || _a7 === void 0 ? void 0 : _a7.engagement_panels) === null || _b2 === void 0 ? void 0 : _b2.filter((panel) => {
      var _a8;
      return (_a8 = panel.content) === null || _a8 === void 0 ? void 0 : _a8.is(StructuredDescriptionContent_default);
    });
    if (description_content !== void 0 && description_content.length > 0) {
      ...
      if (music_section !== void 0 && music_section.length > 0) {
        return (_f = music_section[0].carousel_lockups) === null || _f === void 0 ? void 0 : _f.map((lookup) => {
          var _a8, _b3, _c2, _d2, _e2, _f2, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u;
          let song;
          let artist;
          let album;
          let license;
          let videoId;
          let channelId;
          song = (_b3 = (_a8 = lookup.video_lockup) === null || _a8 === void 0 ? void 0 : _a8.title) === null || _b3 === void 0 ? void 0 : _b3.toString();
...
var Album = class {
  constructor(response) {
    ...
    (0, import_tslib34.__classPrivateFieldSet)(this, _Album_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a7 = (0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item().as(MusicDetailHeader_default);
    this.url = ((_b2 = (0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f").microformat) === null || _b2 === void 0 ? void 0 : _b2.as(MicroformatData_default).url_canonical) || null;
    if (!(0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo)
      throw new Error("No contents found in the response");
    this.contents = (_c = (0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.first().contents;
    this.sections = (0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicCarouselShelf_default) || [];
  }
  get page() {
    return (0, import_tslib34.__classPrivateFieldGet)(this, _Album_page, "f");
  }
};
__name(Album, "Album");
...
var Artist = class {
  constructor(response, actions) {
    ...
    (0, import_tslib35.__classPrivateFieldSet)(this, _Artist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib35.__classPrivateFieldSet)(this, _Artist_actions, actions, "f");
    ...
    const music_shelf = ((_b2 = (0, import_tslib35.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _b2 === void 0 ? void 0 : _b2.getType(MusicShelf_default)) || [];
    const music_carousel_shelf = ((_c = (0, import_tslib35.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _c === void 0 ? void 0 : _c.getType(MusicCarouselShelf_default)) || [];
  ...
  getAllSongs() {
    ...
    return (0, import_tslib35.__awaiter)(this, void 0, void 0, function* () {
      ...
      const page = yield shelf.endpoint.call((0, import_tslib35.__classPrivateFieldGet)(this, _Artist_actions, "f"), { client: "YTMUSIC", parse: true });
  ...
  get page() {
    return (0, import_tslib35.__classPrivateFieldGet)(this, _Artist_page, "f");
  }
};
...
var Explore = class {
  constructor(response) {
    ...
    (0, import_tslib36.__classPrivateFieldSet)(this, _Explore_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a7 = (0, import_tslib36.__classPrivateFieldGet)(this, _Explore_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
  ...
  get page() {
    return (0, import_tslib36.__classPrivateFieldGet)(this, _Explore_page, "f");
  }
};
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib37.__classPrivateFieldSet)(this, _HomeFeed_actions, actions, "f");
    (0, import_tslib37.__classPrivateFieldSet)(this, _HomeFeed_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a7 = (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find Home tab.");
    if (tab.key("content").isNull()) {
      if (!(0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents)
        throw new InnertubeError("Continuation did not have any content.");
      (0, import_tslib37.__classPrivateFieldSet)(this, _HomeFeed_continuation, (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).continuation, "f");
      this.sections = (_b2 = (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicCarouselShelf_default);
      return;
    }
    ...
    (0, import_tslib37.__classPrivateFieldSet)(this, _HomeFeed_continuation, (_e = tab.content) === null || _e === void 0 ? void 0 : _e.as(SectionList_default).continuation, "f");
  ...
  getContinuation() {
    return (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f")
      });
      return new HomeFeed2(response, (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  applyFilter(target_filter) {
    ...
    return (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield cloud_chip.endpoint.call((0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"), { client: "YTMUSIC" });
      return new HomeFeed2(response, (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  get filters() {
  ...
  get has_continuation() {
    return !!(0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f");
  }
  get page() {
    return (0, import_tslib37.__classPrivateFieldGet)(this, _HomeFeed_page, "f");
  }
};
...
var Library2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _Library_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib38.__classPrivateFieldSet)(this, _Library_actions, actions, "f");
    const section_list = (_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(SectionList_default).first();
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _Library_continuation, (_e = (_d = this.contents) === null || _d === void 0 ? void 0 : _d.find((list) => list.continuation)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
  }
  applySort(sort_by) {
    var _a7, _b2, _c, _d, _e, _f, _g, _h, _j, _k;
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(MusicSortFilterButton_default).first();
      ...
      const response = yield (0, import_tslib38.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: cmd.continuation.reloadContinuationData.continuation,
        parse: true
      });
      const previously_selected_item = (_h = (_g = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicMultiSelectMenuItem_default)) === null || _h === void 0 ? void 0 : _h.find((item) => item.selected);
  ...
  applyFilter(filter) {
    ...
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
      ...
      const response = yield target_cmd.call((0, import_tslib38.__classPrivateFieldGet)(this, _Library_actions, "f"), { client: "YTMUSIC" });
      return new Library2(response, (0, import_tslib38.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  getContinuation() {
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib38.__classPrivateFieldGet)(this, _Library_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const page = yield (0, import_tslib38.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib38.__classPrivateFieldGet)(this, _Library_continuation, "f")
      });
      return new LibraryContinuation(page, (0, import_tslib38.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib38.__classPrivateFieldGet)(this, _Library_continuation, "f");
  }
  get sort_options() {
    var _a7, _b2;
    const button = (_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(MusicSortFilterButton_default).first();
  ...
  get filters() {
    var _a7, _b2;
    return ((_b2 = (_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ChipCloud_default)) === null || _b2 === void 0 ? void 0 : _b2.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _Library_page, "f");
  }
};
...
var LibraryContinuation = class {
  constructor(response, actions) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _LibraryContinuation_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib38.__classPrivateFieldSet)(this, _LibraryContinuation_actions, actions, "f");
    if (!(0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents)
      throw new InnertubeError("No continuation contents found");
    this.contents = (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents.as(MusicShelfContinuation, GridContinuation);
    (0, import_tslib38.__classPrivateFieldSet)(this, _LibraryContinuation_continuation, ((_a7 = (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents) === null || _a7 === void 0 ? void 0 : _a7.key("continuation").isNull()) ? null : (_b2 = (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents) === null || _b2 === void 0 ? void 0 : _b2.key("continuation").string(), "f");
  }
  getContinuation() {
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const response = yield (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f")
      });
      return new LibraryContinuation(response, (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f");
  }
  get page() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f");
  }
};
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_actions, actions, "f");
    (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, null, "f");
    (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, null, "f");
    if ((0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) {
      const data = (_a7 = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) === null || _a7 === void 0 ? void 0 : _a7.as(MusicPlaylistShelfContinuation);
      this.items = data.contents;
      (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_continuation, data.continuation, "f");
    } else {
      if (((_b2 = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().type) === "MusicEditablePlaylistDetailHeader") {
        this.header = (_d = (_c = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _c === void 0 ? void 0 : _c.item().as(MusicEditablePlaylistDetailHeader_default).header) === null || _d === void 0 ? void 0 : _d.as(MusicDetailHeader_default);
      } else {
        this.header = (_e = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicDetailHeader_default);
      }
      this.items = ((_f = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _f === void 0 ? void 0 : _f.getType(MusicPlaylistShelf_default).first().contents) || null;
      (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_continuation, ((_g = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicPlaylistShelf_default).first().continuation) || null, "f");
    }
  }
  getContinuation() {
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_continuation, "f")
      });
      return new Playlist3(response, (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_actions, "f"));
    });
  }
  getRelated() {
    var _a7, _b2, _c, _d, _e;
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      let section_continuation = (_b2 = (_a7 = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(SectionList_default)) === null || _b2 === void 0 ? void 0 : _b2[0].continuation;
      while (section_continuation) {
        const data = yield (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
          client: "YTMUSIC",
  ...
  getSuggestions(refresh = true) {
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      const require_fetch = refresh || !(0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
      const fetch_promise = require_fetch ? (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_instances2, "m", _Playlist_fetchSuggestions).call(this) : Promise.resolve(null);
      const fetch_result = yield fetch_promise;
      if (fetch_result) {
        (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, fetch_result.items, "f");
        (0, import_tslib39.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, fetch_result.continuation, "f");
      }
      return (fetch_result === null || fetch_result === void 0 ? void 0 : fetch_result.items) || (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
    });
  }
  get page() {
    return (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f");
  }
  get has_continuation() {
    return !!(0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_continuation, "f");
  }
};
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a7, _b2, _c, _d, _e;
  return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
    const continuation = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_suggestions_continuation, "f") || ((_b2 = (_a7 = (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.get("SectionList")) === null || _b2 === void 0 ? void 0 : _b2[0].as(SectionList_default).continuation);
    if (continuation) {
      const page = yield (0, import_tslib39.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation,
        parse: true
      });
...
var Recap = class {
  constructor(response, actions) {
    ...
    (0, import_tslib40.__classPrivateFieldSet)(this, _Recap_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib40.__classPrivateFieldSet)(this, _Recap_actions, actions, "f");
    const header = (_a7 = (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item();
    this.header = (header === null || header === void 0 ? void 0 : header.is(MusicElementHeader_default)) ? (_d = (_c = (_b2 = (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().as(MusicElementHeader_default).element) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.as(HighlightsCarousel_default) : (_e = (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicHeader_default);
    const tab = (_f = (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_page, "f").contents) === null || _f === void 0 ? void 0 : _f.item().as(SingleColumnBrowseResults_default).tabs.firstOfType(Tab_default);
    if (!tab)
      throw new InnertubeError("Target tab not found");
  ...
  getPlaylist() {
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield endpoint.call((0, import_tslib40.__classPrivateFieldGet)(this, _Recap_actions, "f"), { client: "YTMUSIC" });
      return new Playlist_default3(response, (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_actions, "f"));
    });
  }
  get page() {
    return (0, import_tslib40.__classPrivateFieldGet)(this, _Recap_page, "f");
  }
};
__name(Recap, "Recap");
...
var Search2 = class {
  constructor(response, actions, is_filtered) {
    ...
    (0, import_tslib41.__classPrivateFieldSet)(this, _Search_actions, actions, "f");
    (0, import_tslib41.__classPrivateFieldSet)(this, _Search_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents || !(0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo)
      throw new InnertubeError("Response did not contain any contents.");
    const tab = (0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents.item().as(TabbedSearchResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
    ...
    if (is_filtered) {
      (0, import_tslib41.__classPrivateFieldSet)(this, _Search_continuation, (_c = this.contents.firstOfType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.continuation, "f");
    }
  }
  getMore(shelf) {
    return (0, import_tslib41.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield shelf.endpoint.call((0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      if (!response)
        throw new InnertubeError("Endpoint did not return any data");
      return new Search2(response, (0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  getContinuation() {
    return (0, import_tslib41.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib41.__classPrivateFieldGet)(this, _Search_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f").execute("/search", {
        continuation: (0, import_tslib41.__classPrivateFieldGet)(this, _Search_continuation, "f"),
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f"), response);
    });
  }
  applyFilter(target_filter) {
    var _a7, _b2;
    return (0, import_tslib41.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!cloud_chip.endpoint)
        throw new InnertubeError("Selected filter does not have an endpoint.");
      const response = yield cloud_chip.endpoint.call((0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      return new Search2(response, (0, import_tslib41.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  get filters() {
  ...
  get has_continuation() {
    return !!(0, import_tslib41.__classPrivateFieldGet)(this, _Search_continuation, "f");
  }
  get did_you_mean() {
    var _a7;
    return (_a7 = (0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a7;
    return (_a7 = (0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ShowingResultsFor_default).first();
  }
  get message() {
    var _a7;
    return (_a7 = (0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Message_default).first();
  }
  get songs() {
    var _a7;
  ...
  get page() {
    return (0, import_tslib41.__classPrivateFieldGet)(this, _Search_page, "f");
  }
};
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    (0, import_tslib41.__classPrivateFieldSet)(this, _SearchContinuation_actions, actions, "f");
    (0, import_tslib41.__classPrivateFieldSet)(this, _SearchContinuation_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a7 = (0, import_tslib41.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item().as(MusicHeader_default);
    this.contents = (_b2 = (0, import_tslib41.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").continuation_contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicShelfContinuation);
  }
  getContinuation() {
    var _a7;
    return (0, import_tslib41.__awaiter)(this, void 0, void 0, function* () {
      if (!((_a7 = this.contents) === null || _a7 === void 0 ? void 0 : _a7.continuation))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib41.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f").execute("/search", {
        continuation: this.contents.continuation,
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib41.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f"), response);
    });
  }
  get has_continuation() {
    var _a7;
  ...
  get page() {
    return (0, import_tslib41.__classPrivateFieldGet)(this, _SearchContinuation_page, "f");
  }
};
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    (0, import_tslib46.__classPrivateFieldSet)(this, _Author_nav_text, new Text(item), "f");
    this.id = id || ((_e = (_d = (_c = (_b2 = (_a7 = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _a7 === void 0 ? void 0 : _a7.runs) === null || _b2 === void 0 ? void 0 : _b2[0]) === null || _c === void 0 ? void 0 : _c.endpoint) === null || _d === void 0 ? void 0 : _d.payload) === null || _e === void 0 ? void 0 : _e.browseId) || ((_h = (_g = (_f = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _f === void 0 ? void 0 : _f.endpoint) === null || _g === void 0 ? void 0 : _g.payload) === null || _h === void 0 ? void 0 : _h.browseId) || "N/A";
    this.name = ((_j = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _j === void 0 ? void 0 : _j.text) || "N/A";
    this.thumbnails = thumbs ? Thumbnail.fromResponse(thumbs) : [];
    this.endpoint = ((_m = (_l = (_k = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _k === void 0 ? void 0 : _k.runs) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.endpoint) || ((_o = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _o === void 0 ? void 0 : _o.endpoint);
    ...
    this.url = ((_w = (_v = (_u = (_t = (_s = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _s === void 0 ? void 0 : _s.runs) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.endpoint) === null || _v === void 0 ? void 0 : _v.metadata) === null || _w === void 0 ? void 0 : _w.api_url) === "/browse" && `${URLS.YT_BASE}${((_1 = (_0 = (_z = (_y = (_x = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _x === void 0 ? void 0 : _x.runs) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z.endpoint) === null || _0 === void 0 ? void 0 : _0.payload) === null || _1 === void 0 ? void 0 : _1.canonicalBaseUrl) || `/u/${(_6 = (_5 = (_4 = (_3 = (_2 = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _2 === void 0 ? void 0 : _2.runs) === null || _3 === void 0 ? void 0 : _3[0]) === null || _4 === void 0 ? void 0 : _4.endpoint) === null || _5 === void 0 ? void 0 : _5.payload) === null || _6 === void 0 ? void 0 : _6.browseId}`}` || `${URLS.YT_BASE}${((_9 = (_8 = (_7 = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _7 === void 0 ? void 0 : _7.endpoint) === null || _8 === void 0 ? void 0 : _8.payload) === null || _9 === void 0 ? void 0 : _9.canonicalBaseUrl) || `/u/${(_12 = (_11 = (_10 = (0, import_tslib46.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _10 === void 0 ? void 0 : _10.endpoint) === null || _11 === void 0 ? void 0 : _11.payload) === null || _12 === void 0 ? void 0 : _12.browseId}`}`;
  }
  get best_thumbnail() {
    return this.thumbnails[0];
  }
...
var Platform = class {
  static load(platform) {
    (0, import_tslib47.__classPrivateFieldSet)(Platform, _a4, platform, "f", _Platform_shim);
  }
  static get shim() {
    if (!(0, import_tslib47.__classPrivateFieldGet)(Platform, _a4, "f", _Platform_shim)) {
      throw new Error("Platform is not loaded");
    }
    return (0, import_tslib47.__classPrivateFieldGet)(Platform, _a4, "f", _Platform_shim);
  }
};
...
function streamToIterable(stream) {
  return (0, import_tslib47.__asyncGenerator)(this, arguments, /* @__PURE__ */ __name(function* streamToIterable_1() {
    const reader = stream.getReader();
    try {
      while (true) {
        const { done, value } = yield (0, import_tslib47.__await)(reader.read());
        if (done) {
          return yield (0, import_tslib47.__await)(void 0);
        }
        yield yield (0, import_tslib47.__await)(value);
      }
    } finally {
      reader.releaseLock();
    }
...
var CustomEvent = class extends Event {
  constructor(type, options) {
    ...
    (0, import_tslib48.__classPrivateFieldSet)(this, _CustomEvent_detail, (_a7 = options === null || options === void 0 ? void 0 : options.detail) !== null && _a7 !== void 0 ? _a7 : null, "f");
  }
  get detail() {
    return (0, import_tslib48.__classPrivateFieldGet)(this, _CustomEvent_detail, "f");
  }
};
...
var Actions = class {
  constructor(session) {
    ...
    (0, import_tslib49.__classPrivateFieldSet)(this, _Actions_session, session, "f");
  }
  get session() {
    return (0, import_tslib49.__classPrivateFieldGet)(this, _Actions_session, "f");
  }
  stats(url, client, params) {
    return (0, import_tslib49.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib49.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(s_url);
      return response;
    });
  }
    ...
    return (0, import_tslib49.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if ((0, import_tslib49.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !(0, import_tslib49.__classPrivateFieldGet)(this, _Actions_session, "f").logged_in)
      ...
      const response = yield (0, import_tslib49.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(target_endpoint, {
        method: "POST",
      ...
      if (args === null || args === void 0 ? void 0 : args.parse) {
        ...
        if ((0, import_tslib49.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && ((_b2 = (_a7 = parsed_response.on_response_received_actions) === null || _a7 === void 0 ? void 0 : _a7.first()) === null || _b2 === void 0 ? void 0 : _b2.type) === "navigateAction") {
      ...
      return (0, import_tslib49.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_wrap).call(this, response);
    });
  }
};
...
var Player = class {
  constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
    ...
    (0, import_tslib50.__classPrivateFieldSet)(this, _Player_nsig_sc, nsig_sc, "f");
    (0, import_tslib50.__classPrivateFieldSet)(this, _Player_sig_sc, sig_sc, "f");
    (0, import_tslib50.__classPrivateFieldSet)(this, _Player_sig_sc_timestamp, signature_timestamp, "f");
    (0, import_tslib50.__classPrivateFieldSet)(this, _Player_player_id, player_id, "f");
  }
  ...
  decipher(url, signature_cipher, cipher) {
    ...
    if (signature_cipher || cipher) {
      const signature = Platform.shim.eval((0, import_tslib50.__classPrivateFieldGet)(this, _Player_sig_sc, "f"), {
        sig: args.get("s")
      });
    ...
    if (n) {
      const nsig = Platform.shim.eval((0, import_tslib50.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"), {
        nsig: n
      });
  ...
  cache(cache) {
    return (0, import_tslib50.__awaiter)(this, void 0, void 0, function* () {
      ...
      const sig_buf = encoder.encode((0, import_tslib50.__classPrivateFieldGet)(this, _Player_sig_sc, "f"));
      const nsig_buf = encoder.encode((0, import_tslib50.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"));
      const buffer = new ArrayBuffer(12 + sig_buf.byteLength + nsig_buf.byteLength);
      const view = new DataView(buffer);
      view.setUint32(0, Player.LIBRARY_VERSION, true);
      view.setUint32(4, (0, import_tslib50.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f"), true);
      ...
      yield cache.set((0, import_tslib50.__classPrivateFieldGet)(this, _Player_player_id, "f"), new Uint8Array(buffer));
    });
  }
  ...
  get url() {
    return new URL(`/s/player/${(0, import_tslib50.__classPrivateFieldGet)(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, URLS.YT_BASE).toString();
  }
  get sts() {
    return (0, import_tslib50.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f");
  }
  get nsig_sc() {
    return (0, import_tslib50.__classPrivateFieldGet)(this, _Player_nsig_sc, "f");
  }
  get sig_sc() {
    return (0, import_tslib50.__classPrivateFieldGet)(this, _Player_sig_sc, "f");
  }
...
var HTTPClient = class {
  constructor(session, cookie, fetch) {
    ...
    (0, import_tslib51.__classPrivateFieldSet)(this, _HTTPClient_session, session, "f");
    (0, import_tslib51.__classPrivateFieldSet)(this, _HTTPClient_cookie, cookie, "f");
    (0, import_tslib51.__classPrivateFieldSet)(this, _HTTPClient_fetch, fetch || Platform.shim.fetch, "f");
  }
  get fetch_function() {
    return (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f");
  }
  fetch(input, init) {
    return (0, import_tslib51.__awaiter)(this, void 0, void 0, function* () {
      const innertube_url = URLS.API.PRODUCTION_1 + (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").api_version;
      ...
      request_headers.set("X-Goog-Visitor-Id", (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.visitorData || "");
      request_headers.set("X-Origin", request_url.origin);
      request_headers.set("X-Youtube-Client-Version", (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.clientVersion || "");
      if (Platform.shim.server) {
        request_headers.set("User-Agent", getRandomUserAgent("desktop"));
        request_headers.set("origin", request_url.origin);
      }
      request_url.searchParams.set("key", (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").key);
      ...
      if (content_type === "application/json" && is_innertube_req && typeof body === "string") {
        ...
        const n_body = Object.assign(Object.assign({}, json), {
          context: JSON.parse(JSON.stringify((0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context))
        });
        (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_instances, "m", _HTTPClient_adjustContext).call(this, n_body.context, n_body.client);
      ...
      if ((0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").logged_in && is_innertube_req && !is_web_kids) {
        const oauth = (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").oauth;
        ...
        if ((0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f")) {
          const papisid = getStringBetweenStrings((0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"), "PAPISID=", ";");
          if (papisid) {
            request_headers.set("authorization", yield generateSidAuth(papisid));
            request_headers.set("x-goog-authuser", (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_session, "f").account_index.toString());
          }
          request_headers.set("cookie", (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"));
        }
      }
      const request = new Platform.shim.Request(request_url, input instanceof Platform.shim.Request ? input : init);
      const response = yield (0, import_tslib51.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f").call(this, request, {
        body: request_body,
...
var OAuth = class {
  constructor(session) {
    ...
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_session, session, "f");
  }
  init(credentials) {
    return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
      (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_credentials, credentials, "f");
      if (this.validateCredentials()) {
        if (!this.has_access_token_expired)
          (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth", {
            credentials: (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
            status: "SUCCESS"
          });
      } else if (!(yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_loadCachedCredentials).call(this))) {
        yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
      }
    });
  }
  cacheCredentials() {
    ...
    return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
      const encoder = new TextEncoder();
      const data = encoder.encode(JSON.stringify((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f")));
      yield (_a7 = (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.set("youtubei_oauth_credentials", data.buffer);
    });
  }
  removeCache() {
    var _a7;
    return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
      yield (_a7 = (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.remove("youtubei_oauth_credentials");
    });
  }
  refreshIfRequired() {
    return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
      if (this.has_access_token_expired) {
        yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_refreshAccessToken).call(this);
      }
    });
  }
  revokeCredentials() {
    return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
        return;
      yield this.removeCache();
      return (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f").access_token)}`, URLS.YT_BASE), {
        method: "post"
      });
    });
  }
  get credentials() {
    return (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f");
  }
  get has_access_token_expired() {
    const timestamp = (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f") ? new Date((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f").expires).getTime() : -Infinity;
    return new Date().getTime() > timestamp;
  }
  validateCredentials() {
    return (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f") && Reflect.has((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "access_token") && Reflect.has((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "refresh_token") && Reflect.has((0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "expires") || false;
  }
};
__name(OAuth, "OAuth");
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  var _a7;
  return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
    const data = yield (_a7 = (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.get("youtubei_oauth_credentials");
    if (!data)
      return false;
    const decoder = new TextDecoder();
    const credentials = JSON.parse(decoder.decode(data));
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_credentials, {
  ...
  return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = {
      client_id: (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_id,
      scope: OAUTH.SCOPE,
      device_id: Platform.shim.uuidv4(),
      device_model: OAUTH.MODEL_NAME
    };
    const response = yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", URLS.YT_BASE), {
    ...
    (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-pending", response_data);
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_polling_interval, response_data.interval, "f");
    (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_startPolling).call(this, response_data.device_code);
  });
}, "_OAuth_getUserCode"), _OAuth_startPolling = /* @__PURE__ */ __name(function _OAuth_startPolling2(device_code) {
  const poller = setInterval(() => (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
    const data = Object.assign(Object.assign({}, (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { code: device_code, grant_type: OAUTH.GRANT_TYPE });
    try {
      const response = yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", URLS.YT_BASE), {
        body: JSON.stringify(data),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
      ...
      if (response_data.error) {
        switch (response_data.error) {
          case "access_denied":
            (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Access was denied.", { status: "ACCESS_DENIED" }));
            break;
          case "expired_token":
            (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("The device code has expired, restarting auth flow.", { status: "DEVICE_CODE_EXPIRED" }));
            clearInterval(poller);
            (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
            break;
          default:
            break;
        }
      ...
      clearInterval(poller);
      return (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Could not obtain user code.", { status: "FAILED", error: err }));
    }
  }), (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_polling_interval, "f") * 1e3);
}, "_OAuth_startPolling"), _OAuth_refreshAccessToken = /* @__PURE__ */ __name(function _OAuth_refreshAccessToken2() {
  return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
    if (!(0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
      return;
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = Object.assign(Object.assign({}, (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { refresh_token: (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token, grant_type: "refresh_token" });
    const response = yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", URLS.YT_BASE), {
      body: JSON.stringify(data),
      method: "POST",
      headers: {
    ...
    (0, import_tslib52.__classPrivateFieldSet)(this, _OAuth_credentials, {
      access_token: response_data.access_token,
      refresh_token: response_data.refresh_token || (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token,
      expires: expiration_date
    }, "f");
    (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("update-credentials", {
      credentials: (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
      status: "SUCCESS"
    });
  });
  ...
  var _a7;
  return (0, import_tslib52.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", URLS.YT_BASE), { headers: OAUTH.HEADERS });
    ...
    const script = yield (0, import_tslib52.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: URLS.YT_BASE });
...
var Session = class extends EventEmitterLike_default {
  constructor(context, api_key, api_version, account_index, player, cookie, fetch, cache) {
    ...
    (0, import_tslib53.__classPrivateFieldSet)(this, _Session_context, context, "f");
    (0, import_tslib53.__classPrivateFieldSet)(this, _Session_account_index, account_index, "f");
    (0, import_tslib53.__classPrivateFieldSet)(this, _Session_key, api_key, "f");
    (0, import_tslib53.__classPrivateFieldSet)(this, _Session_api_version, api_version, "f");
    (0, import_tslib53.__classPrivateFieldSet)(this, _Session_player, player, "f");
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch) {
    return (0, import_tslib53.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = (0, import_tslib53.__classPrivateFieldGet)(this, _a5, "m", _Session_generateSessionData).call(this, { lang, location, time_zone: tz, device_category, client_name, enable_safety_mode, visitor_data });
      } else {
        session_data = yield (0, import_tslib53.__classPrivateFieldGet)(this, _a5, "m", _Session_retrieveSessionData).call(this, { lang, location, time_zone: tz, device_category, client_name, enable_safety_mode, visitor_data }, fetch);
      }
  ...
  signIn(credentials) {
    return (0, import_tslib53.__awaiter)(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) => (0, import_tslib53.__awaiter)(this, void 0, void 0, function* () {
  ...
  get key() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_key, "f");
  }
  get api_version() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_api_version, "f");
  }
  get client_version() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_context, "f").client.clientVersion;
  }
  get client_name() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_context, "f").client.clientName;
  }
  get account_index() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_account_index, "f");
  }
  get context() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_context, "f");
  }
  get player() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_player, "f");
  }
  get lang() {
    return (0, import_tslib53.__classPrivateFieldGet)(this, _Session_context, "f").client.hl;
  }
};
...
var Kids = class {
  constructor(session) {
    ...
    (0, import_tslib54.__classPrivateFieldSet)(this, _Kids_session, session, "f");
  }
  search(query) {
    return (0, import_tslib54.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(SearchEndpoint_exports.PATH, SearchEndpoint_exports.build({ client: "YTKIDS", query }));
      return new Search_default3((0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a7;
    return (0, import_tslib54.__awaiter)(this, void 0, void 0, function* () {
      const player_payload = PlayerEndpoint_exports.build({
        sts: (_a7 = (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts,
        client: "YTKIDS",
        video_id
      });
      ...
      const player_response = (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(PlayerEndpoint_exports.PATH, player_payload);
      const next_response = (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(NextEndpoint_exports.PATH, next_payload);
      const response = yield Promise.all([player_response, next_response]);
      const cpn = generateRandomString(16);
      return new VideoInfo_default2(response, (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions, cpn);
    });
  }
  getChannel(channel_id) {
    return (0, import_tslib54.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
        browse_id: channel_id,
        client: "YTKIDS"
      }));
      return new Channel_default2((0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getHomeFeed() {
    return (0, import_tslib54.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new HomeFeed_default2((0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
};
__name(Kids, "Kids");
...
var Music = class {
  constructor(session) {
    ...
    (0, import_tslib55.__classPrivateFieldSet)(this, _Music_session, session, "f");
    (0, import_tslib55.__classPrivateFieldSet)(this, _Music_actions, session.actions, "f");
  }
  getInfo(target) {
    if (target instanceof MusicTwoRowItem_default) {
      return (0, import_tslib55.__classPrivateFieldGet)(this, _Music_instances, "m", _Music_fetchInfoFromListItem).call(this, target);
    } else if (typeof target === "string") {
      return (0, import_tslib55.__classPrivateFieldGet)(this, _Music_instances, "m", _Music_fetchInfoFromVideoId).call(this, target);
    }
  ...
  search(query, filters = {}) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(SearchEndpoint_exports.PATH, SearchEndpoint_exports.build({
        query,
        client: "YTMUSIC",
        params: filters.type && filters.type !== "all" ? proto_default.encodeMusicSearchFilters(filters) : void 0
      }));
      return new Search_default2(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
        browse_id: "FEmusic_home",
        client: "YTMUSIC"
      }));
      return new HomeFeed_default(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getExplore() {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
  ...
  getLibrary() {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Library_default2(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getArtist(artist_id) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Artist_default(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getAlbum(album_id) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
  ...
  getPlaylist(playlist_id) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Playlist_default3(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getUpNext(video_id, automix = true) {
    ...
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(NextEndpoint_exports.PATH, Object.assign(Object.assign({}, NextEndpoint_exports.build({ video_id, client: "YTMUSIC" })), { parse: true }));
      ...
      if (!playlist_panel.playlist_id && automix) {
        ...
        if (!automix_preview_video)
          throw new InnertubeError("Automix item not found");
        const page = yield (_c = automix_preview_video.playlist_video) === null || _c === void 0 ? void 0 : _c.endpoint.call((0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), {
          videoId: video_id,
          client: "YTMUSIC",
          parse: true
        });
  ...
  getRelated(video_id) {
    ...
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!tab)
        throw new InnertubeError("Could not find target tab.");
      const page = yield tab.endpoint.call((0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), { client: "YTMUSIC", parse: true });
      if (!page.contents)
  ...
  getRecap() {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Recap_default(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getSearchSuggestions(query) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(GetSearchSuggestionsEndpoint_exports.PATH, Object.assign(Object.assign({}, GetSearchSuggestionsEndpoint_exports.build({ input: query })), { parse: true }));
...
_Music_session = /* @__PURE__ */ new WeakMap(), _Music_actions = /* @__PURE__ */ new WeakMap(), _Music_instances = /* @__PURE__ */ new WeakSet(), _Music_fetchInfoFromVideoId = /* @__PURE__ */ __name(function _Music_fetchInfoFromVideoId2(video_id) {
  ...
  return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
    const player_payload = PlayerEndpoint_exports.build({
      video_id,
      sts: (_a7 = (0, import_tslib55.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts,
      client: "YTMUSIC"
    });
    const next_payload = NextEndpoint_exports.build({
      video_id,
    ...
    const player_response = (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(PlayerEndpoint_exports.PATH, player_payload);
    const next_response = (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f").execute(NextEndpoint_exports.PATH, next_payload);
    const response = yield Promise.all([player_response, next_response]);
    const cpn = generateRandomString(16);
    return new TrackInfo_default(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), cpn);
  });
  ...
  return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
    ...
    const player_response = list_item.endpoint.call((0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), {
      client: "YTMUSIC",
      playbackContext: {
        contentPlaybackContext: Object.assign({
          signatureTimestamp: (_a7 = (0, import_tslib55.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts
        })
      }
    });
    const next_response = list_item.endpoint.call((0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), {
      client: "YTMUSIC",
...
var Studio = class {
  constructor(session) {
    ...
    (0, import_tslib56.__classPrivateFieldSet)(this, _Studio_session, session, "f");
  }
  setThumbnail(video_id, buffer) {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      if (!video_id || !buffer)
      ...
      const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").actions.execute("/video_manager/metadata_update", {
        protobuf: true,
  ...
  upload(file, metadata = {}) {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const initial_data = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_getInitialUploadData).call(this);
      const upload_result = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_uploadVideo).call(this, initial_data.upload_url, file);
      if (upload_result.status !== "STATUS_SUCCESS")
        throw new InnertubeError("Could not process video.");
      const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_setVideoMetadata).call(this, initial_data, upload_result, metadata);
      return response;
    });
  }
};
...
_Studio_session = /* @__PURE__ */ new WeakMap(), _Studio_instances = /* @__PURE__ */ new WeakSet(), _Studio_getInitialUploadData = /* @__PURE__ */ __name(function _Studio_getInitialUploadData2() {
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    ...
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").http.fetch("/upload/youtubei", {
  ...
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").http.fetch_function(upload_url, {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
  ...
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Studio_session, "f").actions.execute(CreateVideoEndpoint_exports.PATH, CreateVideoEndpoint_exports.build({
      resource_id: {
        scotty_resource_id: {
...
var AccountManager = class {
  constructor(actions) {
    ...
    (0, import_tslib57.__classPrivateFieldSet)(this, _AccountManager_actions, actions, "f");
    this.channel = {
      editName: (new_name) => {
        if (!(0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return (0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(channel_exports.EditNameEndpoint.PATH, channel_exports.EditNameEndpoint.build({
          given_name: new_name
        }));
      },
      editDescription: (new_description) => {
        if (!(0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return (0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(channel_exports.EditDescriptionEndpoint.PATH, channel_exports.EditDescriptionEndpoint.build({
  ...
  getInfo() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(account_exports.AccountListEndpoint.PATH, account_exports.AccountListEndpoint.build());
      return new AccountInfo_default(response);
    });
  }
  getTimeWatched() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
  ...
  getSettings() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Settings_default((0, import_tslib57.__classPrivateFieldGet)(this, _AccountManager_actions, "f"), response);
    });
  }
  getAnalytics() {
    var _a7;
...
var PlaylistManager = class {
  constructor(actions) {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _PlaylistManager_actions, actions, "f");
  }
  create(title, video_ids) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      throwIfMissing({ title, video_ids });
      if (!(0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(CreateEndpoint_exports.PATH, CreateEndpoint_exports.build({
        ids: video_ids,
        title
      }));
      return {
  ...
  delete(playlist_id) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(DeleteEndpoint_exports.PATH, DeleteEndpoint_exports.build({
        playlist_id
      }));
      return {
        playlist_id,
  ...
  addVideos(playlist_id, video_ids) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(EditPlaylistEndpoint_exports.PATH, EditPlaylistEndpoint_exports.build({
  ...
  removeVideos(playlist_id, video_ids) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const info = yield (0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(BrowseEndpoint_exports.PATH, Object.assign(Object.assign({}, BrowseEndpoint_exports.build({ browse_id: `VL${playlist_id}` })), { parse: true }));
      const playlist = new Playlist_default2((0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f"), info, true);
      if (!playlist.info.is_editable)
        throw new InnertubeError("This playlist cannot be edited.", playlist_id);
      const payload = { playlist_id, actions: [] };
      const getSetVideoIds = /* @__PURE__ */ __name((pl) => (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(EditPlaylistEndpoint_exports.PATH, EditPlaylistEndpoint_exports.build(payload));
      return {
        playlist_id,
        action_result: response.data.actions
      };
...
var InteractionManager = class {
  constructor(actions) {
    ...
    (0, import_tslib59.__classPrivateFieldSet)(this, _InteractionManager_actions, actions, "f");
  }
  like(video_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      throwIfMissing({ video_id });
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(LikeEndpoint_exports.PATH, LikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  dislike(video_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(DislikeEndpoint_exports.PATH, DislikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  removeRating(video_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(RemoveLikeEndpoint_exports.PATH, RemoveLikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  subscribe(channel_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(SubscribeEndpoint_exports.PATH, SubscribeEndpoint_exports.build({
        client: "ANDROID",
  ...
  unsubscribe(channel_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(UnsubscribeEndpoint_exports.PATH, UnsubscribeEndpoint_exports.build({
        client: "ANDROID",
        channel_ids: [channel_id],
        params: "CgIIAhgA"
      }));
  ...
  comment(video_id, text) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(CreateCommentEndpoint_exports.PATH, CreateCommentEndpoint_exports.build({
        comment_text: text,
  ...
  translate(text, target_language, args = {}) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(PerformCommentActionEndpoint_exports.PATH, PerformCommentActionEndpoint_exports.build({
        client: "ANDROID",
  ...
  setNotificationPreferences(channel_id, type) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      const action = yield (0, import_tslib59.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(ModifyChannelPreferenceEndpoint_exports.PATH, ModifyChannelPreferenceEndpoint_exports.build({
        client: "WEB",
...
var Innertube = class {
  constructor(session) {
    ...
    (0, import_tslib60.__classPrivateFieldSet)(this, _Innertube_session, session, "f");
  }
  ...
  getInfo(target, client) {
    ...
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      const player_payload = PlayerEndpoint_exports.build({
        ...
        client,
        sts: (_e = (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").player) === null || _e === void 0 ? void 0 : _e.sts
      });
  ...
  getBasicInfo(video_id, client) {
    ...
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield this.actions.execute(PlayerEndpoint_exports.PATH, PlayerEndpoint_exports.build({
        video_id,
        client,
        sts: (_a7 = (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts
      }));
      const cpn = generateRandomString(16);
      return new VideoInfo_default([response], this.actions, cpn);
    });
  ...
  getSearchSuggestions(query) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      url.searchParams.set("hl", (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").context.client.hl);
      url.searchParams.set("gl", (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").context.client.gl);
      url.searchParams.set("ds", "yt");
      url.searchParams.set("client", "youtube");
      url.searchParams.set("xssi", "t");
      url.searchParams.set("oe", "UTF");
      const response = yield (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").http.fetch(url);
      const response_data = yield response.text();
  ...
  get music() {
    return new Music_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get studio() {
    return new Studio_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get kids() {
    return new Kids_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get account() {
    return new AccountManager_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get playlist() {
    return new PlaylistManager_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get interact() {
    return new InteractionManager_default((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get actions() {
    return (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions;
  }
  get session() {
    return (0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f");
  }
};
...
var UniversalCache = class {
  constructor(persistent, persistent_directory) {
    ...
    (0, import_tslib61.__classPrivateFieldSet)(this, _UniversalCache_cache, new Platform.shim.Cache(persistent, persistent_directory), "f");
  }
  get cache_dir() {
    return (0, import_tslib61.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").cache_dir;
  }
  get(key) {
    return (0, import_tslib61.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").get(key);
  }
  set(key, value) {
    return (0, import_tslib61.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").set(key, value);
  }
  remove(key) {
    return (0, import_tslib61.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").remove(key);
  }
};
...
var Cache = class {
  constructor(persistent = false, persistent_directory) {
    ...
    (0, import_tslib62.__classPrivateFieldSet)(this, _Cache_persistent_directory, persistent_directory || Cache.default_persistent_directory, "f");
    (0, import_tslib62.__classPrivateFieldSet)(this, _Cache_persistent, persistent, "f");
  }
  ...
  get cache_dir() {
    return (0, import_tslib62.__classPrivateFieldGet)(this, _Cache_persistent, "f") ? (0, import_tslib62.__classPrivateFieldGet)(this, _Cache_persistent_directory, "f") : Cache.temp_directory;
  }
  get(key) {
    return (0, import_tslib62.__awaiter)(this, void 0, void 0, function* () {
      yield (0, import_tslib62.__classPrivateFieldGet)(this, _Cache_instances, "m", _Cache_createCache).call(this);
...
Platform.load({
  ...
  server: true,
  Cache,
  sha1Hash: (data) => (0, import_tslib62.__awaiter)(void 0, void 0, void 0, function* () {
