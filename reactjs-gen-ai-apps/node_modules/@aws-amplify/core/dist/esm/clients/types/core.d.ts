...
type ConfiguredMiddleware<Input extends Request, Output extends Response> = (next: MiddlewareHandler<Input, Output>, context: MiddlewareContext) => MiddlewareHandler<Input, Output>;
/**
 * A slimmed down version of the AWS SDK v3 middleware, only handling tasks after Serde.
 */
export type Middleware<Input extends Request, Output extends Response, MiddlewareOptions> = (options: MiddlewareOptions) => ConfiguredMiddleware<Input, Output>;
