import { AuthUserAttributes, AuthUserAttribute, AuthUserAttributeKey, AuthDevice } from './models';
import { AuthServiceOptions, AuthSignUpOptions } from './options';
export type AuthConfirmResetPasswordInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    username: string;
    newPassword: string;
 ...
 */
export type AuthResendSignUpCodeInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    username: string;
    options?: ServiceOptions;
};
export type AuthResetPasswordInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    username: string;
    options?: ServiceOptions;
};
 ...
 */
export type AuthSignUpInput<ServiceOptions extends AuthSignUpOptions<AuthUserAttributeKey> = AuthSignUpOptions<AuthUserAttributeKey>> = {
    username: string;
    password: string;
    options?: ServiceOptions;
};
 ...
 * @param options - optional parameters for the Sign Up process, including user attributes
 */
export type AuthConfirmSignUpInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    username: string;
    confirmationCode: string;
    options?: ServiceOptions;
};
 ...
 */
export type AuthConfirmSignInInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
 ...
 */
export type AuthVerifyTOTPSetupInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    code: string;
    options?: ServiceOptions;
};
/**
 ...
 */
export type AuthUpdateUserAttributesInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
 ...
 * @param options - optional parameters for the Update User Attributes process such as the service options.
 */
export type AuthUpdateUserAttributeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    userAttribute: AuthUserAttribute<UserAttributeKey>;
    options?: ServiceOptions;
};
export type AuthConfirmUserAttributeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey> = {
 ...
 */
export type AuthSendUserAttributeVerificationCodeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> = {
    userAttributeKey: UserAttributeKey;
    options?: ServiceOptions;
};
/**
 ...
 */
export type AuthDeleteUserAttributesInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey> = {
