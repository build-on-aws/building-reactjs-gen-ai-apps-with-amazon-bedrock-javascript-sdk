import { AuthServiceOptions, AuthSignUpOptions, AuthUserAttributes, AuthUserAttributeKey } from '../../../types';
 ...
 */
export type SignUpOptions<UserAttributeKey extends AuthUserAttributeKey> = AuthSignUpOptions<UserAttributeKey> & {
