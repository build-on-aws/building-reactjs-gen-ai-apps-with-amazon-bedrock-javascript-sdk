...
import { AuthMFAType, AuthUserAttributes, AuthCodeDeliveryDetails, AuthTOTPSetupDetails, AuthSignInOutput, AuthSignUpOutput, AuthResetPasswordOutput, AuthUpdateUserAttributesOutput, AuthUpdateUserAttributeOutput } from '../../../types';
 ...
 */
export type ResendSignUpCodeOutput = AuthCodeDeliveryDetails<AuthVerifiableAttributeKey>;
/**
 * Output type for Cognito resetPassword API.
 */
export type ResetPasswordOutput = AuthResetPasswordOutput<AuthVerifiableAttributeKey>;
/**
 ...
 */
export type UpdateUserAttributesOutput = AuthUpdateUserAttributesOutput<UserAttributeKey>;
/**
 * Output type for Cognito sendUserAttributeVerificationCode API.
 */
export type SendUserAttributeVerificationCodeOutput = AuthCodeDeliveryDetails<AuthVerifiableAttributeKey>;
/**
 * Output type for Cognito updateUserAttribute API.
 */
export type UpdateUserAttributeOutput = AuthUpdateUserAttributeOutput<UserAttributeKey>;
/**
