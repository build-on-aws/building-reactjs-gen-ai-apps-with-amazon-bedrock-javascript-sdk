...
export type TabsItemProps<Element extends ElementType = 'button'> = PrimitiveProps<BaseTabsItemProps, Element>;
export interface BaseTabsPanelProps extends BaseViewProps {
    value: string;
}
export type TabsPanelProps<Element extends ElementType = 'div'> = PrimitiveProps<BaseTabsPanelProps, Element>;
...
export type TabsListProps<Element extends ElementType = 'div'> = PrimitiveProps<BaseTabsListProps, Element>;
