 ...
 */
type ReturnValue<M extends Model, FlatModel extends Model, Paths extends ReadonlyArray<ModelPath<FlatModel>>> = Paths extends never[] ? M : CustomSelectionSetReturnValue<FlatModel, Paths[number]>;
/**
...
type ModelIdentifier<Model extends Record<any, any>> = Prettify<Record<Model['identifier'] & string, string>>;
...
type ModelTypesClient<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = {
    ...
    get<FlatModel extends Record<string, unknown> = ResolvedModel<Model>, SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(identifier: ModelIdentifier<ModelMeta>, options?: {
...
type ModelTypesSSRCookies<Model extends Record<string, unknown>, ModelMeta extends Record<string, unknown>> = {
    create: (model: Prettify<CreateModelInput<Model, ModelMeta>>, options?: {
        authMode?: AuthMode;
        authToken?: string;
        headers?: CustomHeaders;
...
type ModelTypesSSRRequest<Model extends Record<string, unknown>, ModelMeta extends Record<string, unknown>> = {
    ...
    get<FlatModel extends Record<string, unknown> = ResolvedModel<Model>, SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(contextSpec: any, identifier: ModelIdentifier<ModelMeta>, options?: {
        selectionSet?: SelectionSet;
        authMode?: AuthMode;
        authToken?: string;
        headers?: CustomHeaders;
