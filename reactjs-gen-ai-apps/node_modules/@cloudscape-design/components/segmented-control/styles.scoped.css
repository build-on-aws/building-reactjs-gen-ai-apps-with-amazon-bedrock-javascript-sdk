...
body[data-awsui-focus-visible=true] .awsui_segment_8cbea_sud5v_97:not(#\9):focus::before {
  ...
  inline-size: calc(100% + 2 * var(--space-segmented-control-focus-outline-gutter-gbye20, 4px));
  block-size: calc(100% + 2 * var(--space-segmented-control-focus-outline-gutter-gbye20, 4px));
