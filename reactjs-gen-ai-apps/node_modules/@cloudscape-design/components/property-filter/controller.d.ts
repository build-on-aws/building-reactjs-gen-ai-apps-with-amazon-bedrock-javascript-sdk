...
export declare const parseText: (filteringText: string, filteringProperties: readonly InternalFilteringProperty[], disableFreeTextFiltering: boolean) => ParsedText;
