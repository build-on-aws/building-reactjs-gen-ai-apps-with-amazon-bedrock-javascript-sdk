...
.awsui_input_2rhyz_w1dso_97.awsui_input-readonly_2rhyz_w1dso_147:not(#\9) {
  background-color: var(--color-background-input-default-igdh5e, #ffffff);
...
.awsui_input_2rhyz_w1dso_97:not(#\9)::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-mx1ygd, #5f6b7a);
  font-style: italic;
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_w1dso_97:not(#\9)::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-mx1ygd, #5f6b7a);
  font-style: italic;
}
.awsui_input_2rhyz_w1dso_97:not(#\9)::-moz-placeholder {
  color: var(--color-text-input-placeholder-mx1ygd, #5f6b7a);
  font-style: italic;
  opacity: 1;
}
...
.awsui_input_2rhyz_w1dso_97:not(#\9):focus {
...
.awsui_input_2rhyz_w1dso_97:not(#\9):disabled {
...
.awsui_input_2rhyz_w1dso_97:not(#\9):disabled::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-abhb0d, #9ba7b6);
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_w1dso_97:not(#\9):disabled::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-abhb0d, #9ba7b6);
}
.awsui_input_2rhyz_w1dso_97:not(#\9):disabled::-moz-placeholder {
  color: var(--color-text-input-placeholder-disabled-abhb0d, #9ba7b6);
  opacity: 1;
}
.awsui_input_2rhyz_w1dso_97:not(#\9):disabled:-ms-input-placeholder {
...
.awsui_input_2rhyz_w1dso_97:not(#\9):invalid {
  box-shadow: none;
}
.awsui_input_2rhyz_w1dso_97.awsui_input-invalid_2rhyz_w1dso_214:not(#\9) {
...
.awsui_input_2rhyz_w1dso_97.awsui_input-invalid_2rhyz_w1dso_214:not(#\9):focus {
...
.awsui_input_2rhyz_w1dso_97.awsui_input-invalid_2rhyz_w1dso_214.awsui_input-has-icon-left_2rhyz_w1dso_225:not(#\9) {
  padding-inline-start: calc(
        var(--space-field-icon-offset-csk9vw, 36px) - (var(--border-invalid-width-5ktjp2, 8px) - var(--border-field-width-09w7vk, 2px))
      );
}
.awsui_input_2rhyz_w1dso_97.awsui_input-type-search_2rhyz_w1dso_230:not(#\9) {
  box-sizing: border-box;
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_w1dso_97.awsui_input-type-search_2rhyz_w1dso_230:not(#\9)::-ms-clear {
  display: none;
}
.awsui_input_2rhyz_w1dso_97.awsui_input-type-search_2rhyz_w1dso_230:not(#\9)::-webkit-search-decoration {
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_w1dso_97.awsui_input-type-search_2rhyz_w1dso_230:not(#\9)::-webkit-search-cancel-button {
  display: none;
}
.awsui_input_2rhyz_w1dso_97.awsui_input-has-icon-left_2rhyz_w1dso_225:not(#\9) {
  padding-inline-start: var(--space-field-icon-offset-csk9vw, 36px);
}
.awsui_input_2rhyz_w1dso_97.awsui_input-has-icon-right_2rhyz_w1dso_246:not(#\9) {
  padding-inline-end: var(--space-field-icon-offset-csk9vw, 36px);
}
.awsui_input_2rhyz_w1dso_97.awsui_input-has-no-border-radius_2rhyz_w1dso_249:not(#\9) {
...
.awsui_input-container_2rhyz_w1dso_256:not(#\9) {
  display: flex;
  position: relative;
}

.awsui_input-icon-left_2rhyz_w1dso_261:not(#\9) {
  position: absolute;
  pointer-events: none;
...
.awsui_input-icon-right_2rhyz_w1dso_268:not(#\9) {
  position: absolute;
  inset-block-start: calc(50% - var(--line-height-body-m-30ar75, 20px) / 2);
  inset-inline-end: calc(var(--space-field-horizontal-gg19kw, 12px) - var(--space-xxs-p8yyaw, 4px));
}

.awsui_input-button-right_2rhyz_w1dso_274:not(#\9) {
  /* used in test-utils */
}