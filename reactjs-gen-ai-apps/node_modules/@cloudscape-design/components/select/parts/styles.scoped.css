...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_placeholder_dwuol_1pihy_93:not(#\9) {
  color: var(--color-text-input-placeholder-mx1ygd, #5f6b7a);
  font-style: italic;
}

.awsui_item_dwuol_1pihy_98:not(#\9) {
  display: flex;
  align-items: center;
}
.awsui_item_dwuol_1pihy_98 > .awsui_checkbox_dwuol_1pihy_102:not(#\9) {
  position: relative;
...
.awsui_filter_dwuol_1pihy_111:not(#\9) {
  z-index: 4;
  flex-shrink: 0;
}

.awsui_trigger_dwuol_1pihy_116:not(#\9) {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}

.awsui_layout-strut_dwuol_1pihy_122:not(#\9) {
  inline-size: 100%;
  position: relative;
  transform: translate3d(0, 0, 0);
}

.awsui_list-bottom_dwuol_1pihy_128:not(#\9) {
  /* used in unit-tests */
}

.awsui_selected-icon_dwuol_1pihy_132:not(#\9) {
  color: var(--color-border-item-focused-b2ntyl, #0972d3);
}

.awsui_show-label-tag_dwuol_1pihy_136 > .awsui_selected-icon_dwuol_1pihy_132:not(#\9) {
  padding-inline-start: var(--space-scaled-s-aqzyko, 12px);
}

.awsui_inline-token-trigger_dwuol_1pihy_140:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
...
.awsui_inline-token-list_dwuol_1pihy_147:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
.awsui_inline-token-list_dwuol_1pihy_147 > .awsui_inline-token_dwuol_1pihy_140:not(#\9) {
  display: flex;
  align-items: center;
...
.awsui_visual-refresh_dwuol_1pihy_173 > .awsui_inline-token-list_dwuol_1pihy_147 > .awsui_inline-token_dwuol_1pihy_140:not(#\9) {
...
.awsui_inline-token-hidden-placeholder_dwuol_1pihy_180:not(#\9) {
  position: absolute !important;
  inset-block-start: -9999px !important;
  inset-inline-start: -9999px !important;
}

.awsui_inline-token-counter_dwuol_1pihy_186:not(#\9) {
  white-space: nowrap;
}

.awsui_inline-token-trigger--disabled_dwuol_1pihy_190 > .awsui_inline-token-list_dwuol_1pihy_147 > .awsui_inline-token_dwuol_1pihy_140:not(#\9) {
