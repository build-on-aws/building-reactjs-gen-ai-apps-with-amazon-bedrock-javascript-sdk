...
declare const ListAgentVersionsCommand_base: {
    new (input: ListAgentVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentVersionsCommandInput, ListAgentVersionsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
