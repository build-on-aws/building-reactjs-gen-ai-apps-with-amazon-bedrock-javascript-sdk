...
declare const DeleteAgentActionGroupCommand_base: {
    new (input: DeleteAgentActionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentActionGroupCommandInput, DeleteAgentActionGroupCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteAgentActionGroupCommand extends DeleteAgentActionGroupCommand_base {
}
