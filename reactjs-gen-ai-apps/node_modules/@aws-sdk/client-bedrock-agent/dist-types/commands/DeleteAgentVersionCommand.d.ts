...
declare const DeleteAgentVersionCommand_base: {
    new (input: DeleteAgentVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentVersionCommandInput, DeleteAgentVersionCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteAgentVersionCommand extends DeleteAgentVersionCommand_base {
}
