...
declare const UpdateAgentKnowledgeBaseCommand_base: {
    new (input: UpdateAgentKnowledgeBaseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAgentKnowledgeBaseCommandInput, UpdateAgentKnowledgeBaseCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class UpdateAgentKnowledgeBaseCommand extends UpdateAgentKnowledgeBaseCommand_base {
}
