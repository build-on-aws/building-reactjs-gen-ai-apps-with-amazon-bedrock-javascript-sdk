...
declare const CreateAgentAliasCommand_base: {
    new (input: CreateAgentAliasCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAgentAliasCommandInput, CreateAgentAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class CreateAgentAliasCommand extends CreateAgentAliasCommand_base {
}
