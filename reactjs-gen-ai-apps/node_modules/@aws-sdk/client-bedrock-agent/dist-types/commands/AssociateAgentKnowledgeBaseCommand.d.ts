...
declare const AssociateAgentKnowledgeBaseCommand_base: {
    new (input: AssociateAgentKnowledgeBaseCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateAgentKnowledgeBaseCommandInput, AssociateAgentKnowledgeBaseCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class AssociateAgentKnowledgeBaseCommand extends AssociateAgentKnowledgeBaseCommand_base {
}
