...
declare const PrepareAgentCommand_base: {
    new (input: PrepareAgentCommandInput): import("@smithy/smithy-client").CommandImpl<PrepareAgentCommandInput, PrepareAgentCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class PrepareAgentCommand extends PrepareAgentCommand_base {
}
