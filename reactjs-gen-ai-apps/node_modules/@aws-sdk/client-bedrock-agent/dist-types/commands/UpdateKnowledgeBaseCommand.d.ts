...
declare const UpdateKnowledgeBaseCommand_base: {
    new (input: UpdateKnowledgeBaseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateKnowledgeBaseCommandInput, UpdateKnowledgeBaseCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
