...
declare const UpdateDataSourceCommand_base: {
    new (input: UpdateDataSourceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDataSourceCommandInput, UpdateDataSourceCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
