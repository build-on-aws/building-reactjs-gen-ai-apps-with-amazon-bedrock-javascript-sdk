...
declare const ListAgentAliasesCommand_base: {
    new (input: ListAgentAliasesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentAliasesCommandInput, ListAgentAliasesCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
