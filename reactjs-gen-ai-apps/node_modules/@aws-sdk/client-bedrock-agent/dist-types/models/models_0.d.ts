 ...
 * @public
 */
export type IngestionJobFilterAttribute = (typeof IngestionJobFilterAttribute)[keyof typeof IngestionJobFilterAttribute];
/**
 * @public
 * @enum
 */
 ...
 * @public
 */
export type IngestionJobSortByAttribute = (typeof IngestionJobSortByAttribute)[keyof typeof IngestionJobSortByAttribute];
/**
 * @public
 * @enum
 */
 ...
 * @internal
 */
export declare const CreateAgentActionGroupRequestFilterSensitiveLog: (obj: CreateAgentActionGroupRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const CreateAgentActionGroupResponseFilterSensitiveLog: (obj: CreateAgentActionGroupResponse) => any;
/**
 * @internal
 */
export declare const GetAgentActionGroupResponseFilterSensitiveLog: (obj: GetAgentActionGroupResponse) => any;
/**
 * @internal
 */
export declare const UpdateAgentActionGroupRequestFilterSensitiveLog: (obj: UpdateAgentActionGroupRequest) => any;
/**
 * @internal
 */
export declare const UpdateAgentActionGroupResponseFilterSensitiveLog: (obj: UpdateAgentActionGroupResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const GetAgentResponseFilterSensitiveLog: (obj: GetAgentResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const GetAgentVersionResponseFilterSensitiveLog: (obj: GetAgentVersionResponse) => any;
