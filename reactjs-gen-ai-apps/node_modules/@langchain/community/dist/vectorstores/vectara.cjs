...
const testing_js_1 = require("../utils/testing.cjs");
...
class VectaraStore extends vectorstores_1.VectorStore {
    ...
    constructor(args) {
        ...
        super(new testing_js_1.FakeEmbeddings(), args);
    ...
    static fromTexts(texts, metadatas, _embeddings, args) {
        ...
        return VectaraStore.fromDocuments(docs, new testing_js_1.FakeEmbeddings(), args);
    }
    /**
