...
export declare function createOllamaGenerateStream(baseUrl: string, params: OllamaGenerateRequestParams, options: BaseLanguageModelCallOptions): AsyncGenerator<OllamaGenerationChunk>;
export declare function createOllamaChatStream(baseUrl: string, params: OllamaChatRequestParams, options: BaseLanguageModelCallOptions): AsyncGenerator<OllamaChatGenerationChunk>;
