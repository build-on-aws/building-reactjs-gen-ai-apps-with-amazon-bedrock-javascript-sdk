...
class AmplifyNodePkgDetector {
    constructor(amplifyDetectorProps, packageManager) {
        ...
        this.lockFileParser = parser_factory_1.LockFileParserFactory.getLockFileParser(this.packageManager);
    }
}
exports.AmplifyNodePkgDetector = AmplifyNodePkgDetector;
_a = AmplifyNodePkgDetector;
AmplifyNodePkgDetector.getInstance = async (amplifyDetectorProps) => {
    const packageManager = await (0, packageManager_1.getPackageManager)(amplifyDetectorProps.projectRoot);
