...
class PluginPlatform {
    constructor() {
        this.pluginDirectories = [
            constants_1.constants.LOCAL_NODE_MODULES,
            constants_1.constants.PARENT_DIRECTORY,
            constants_1.constants.GLOBAL_NODE_MODULES,
            constants_1.constants.DEV_NODE_MODULES,
        ];
