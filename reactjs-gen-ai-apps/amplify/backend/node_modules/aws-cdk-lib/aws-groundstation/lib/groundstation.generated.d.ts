...
export declare namespace CfnDataflowEndpointGroup {
    ...
    interface AwsGroundStationAgentEndpointProperty {
         ...
         */
        readonly ingressAddress?: CfnDataflowEndpointGroup.RangedConnectionDetailsProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnDataflowEndpointGroup {
    ...
    interface ConnectionDetailsProperty {
         ...
         */
        readonly socketAddress?: CfnDataflowEndpointGroup.SocketAddressProperty | cdk.IResolvable;
    }
}
export declare namespace CfnDataflowEndpointGroup {
    /**
...
export declare namespace CfnDataflowEndpointGroup {
    ...
    interface RangedConnectionDetailsProperty {
         ...
         */
        readonly socketAddress?: CfnDataflowEndpointGroup.RangedSocketAddressProperty | cdk.IResolvable;
    }
}
export declare namespace CfnDataflowEndpointGroup {
    /**
...
export interface CfnMissionProfileProps {
     ...
     */
    readonly streamsKmsKey?: CfnMissionProfile.StreamsKmsKeyProperty | cdk.IResolvable;
    /**
...
export declare class CfnMissionProfile extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-missionprofile.html#cfn-groundstation-missionprofile-streamskmskey
     */
    streamsKmsKey: CfnMissionProfile.StreamsKmsKeyProperty | cdk.IResolvable | undefined;
    /**
     * `AWS::GroundStation::MissionProfile.StreamsKmsRole`
     *
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-missionprofile.html#cfn-groundstation-missionprofile-streamskmsrole
