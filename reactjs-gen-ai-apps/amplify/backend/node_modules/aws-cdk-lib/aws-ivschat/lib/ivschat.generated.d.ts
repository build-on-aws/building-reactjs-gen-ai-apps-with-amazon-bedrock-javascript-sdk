...
export declare class CfnLoggingConfiguration extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    static readonly CFN_RESOURCE_TYPE_NAME = "AWS::IVSChat::LoggingConfiguration";
    /**
...
export declare namespace CfnLoggingConfiguration {
    ...
    interface DestinationConfigurationProperty {
         ...
         */
        readonly s3?: CfnLoggingConfiguration.S3DestinationConfigurationProperty | cdk.IResolvable;
    }
}
export declare namespace CfnLoggingConfiguration {
    /**
...
export interface CfnRoomProps {
     ...
     */
    readonly messageReviewHandler?: CfnRoom.MessageReviewHandlerProperty | cdk.IResolvable;
    /**
 ...
 * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivschat-room.html
 */
export declare class CfnRoom extends cdk.CfnResource implements cdk.IInspectable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME = "AWS::IVSChat::Room";
    /**
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivschat-room.html#cfn-ivschat-room-messagereviewhandler
     */
    messageReviewHandler: CfnRoom.MessageReviewHandlerProperty | cdk.IResolvable | undefined;
    /**
     * Room name. The value does not need to be unique.
     *
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivschat-room.html#cfn-ivschat-room-name
