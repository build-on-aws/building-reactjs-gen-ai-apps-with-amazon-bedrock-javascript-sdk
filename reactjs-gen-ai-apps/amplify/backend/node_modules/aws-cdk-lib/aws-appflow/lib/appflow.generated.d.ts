...
export declare namespace CfnConnectorProfile {
    ...
    interface ConnectorProfileCredentialsProperty {
         ...
         */
        readonly pardot?: CfnConnectorProfile.PardotConnectorProfileCredentialsProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnConnectorProfile {
    ...
    interface ConnectorProfilePropertiesProperty {
         ...
         */
        readonly pardot?: CfnConnectorProfile.PardotConnectorProfilePropertiesProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnFlow {
    ...
    interface SourceConnectorPropertiesProperty {
         ...
         */
        readonly pardot?: CfnFlow.PardotSourcePropertiesProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnFlow {
    ...
    interface TriggerConfigProperty {
        /**
         * `CfnFlow.TriggerConfigProperty.ActivateFlowOnCreate`
         *
         * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-triggerconfig.html#cfn-appflow-flow-triggerconfig-activateflowoncreate
         */
        readonly activateFlowOnCreate?: boolean | cdk.IResolvable;
        /**
         * Specifies the configuration details of a schedule-triggered flow as defined by the user. Currently, these settings only apply to the `Scheduled` trigger type.
         *
