...
export declare namespace CfnFirewallPolicy {
    ...
    interface FirewallPolicyProperty {
         ...
         */
        readonly policyVariables?: CfnFirewallPolicy.PolicyVariablesProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnFirewallPolicy {
    ...
    interface PolicyVariablesProperty {
         ...
         */
        readonly ruleVariables?: {
            [key: string]: (CfnFirewallPolicy.IPSetProperty | cdk.IResolvable);
        } | cdk.IResolvable;
    }
}
export declare namespace CfnFirewallPolicy {
